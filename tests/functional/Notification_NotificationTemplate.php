...
class Notification_NotificationTemplate extends DbTestCase
{
    ...
    public function testGetTabNameForItem()
    {
       ...
       //not logged => no ACLs
        ...
        $this->login();
        $name = $n_nt->getTabNameForItem($notif);
        $this->string($name)->isIdenticalTo("<span><i class='ti ti-template me-2'></i>Templates</span> <span class='badge bg-secondary text-secondary-fg'>1</span>");
        ...
        $_SESSION['glpishow_count_on_tabs'] = 1;
        $name = $n_nt->getTabNameForItem($notif);
        $this->string($name)->isIdenticalTo("<span><i class='ti ti-template me-2'></i>Templates</span> <span class='badge bg-secondary text-secondary-fg'>2</span>");
    }
