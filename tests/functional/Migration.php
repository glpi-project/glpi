    ...
    public function testAddConfig()
    {
       ...
       //test with non-existing value => new keys should be inserted
        ...
        $core_queries = [
            ...
            'SELECT `table_name` AS `TABLE_NAME` FROM `information_schema`.`tables` WHERE `table_schema` = \'' . $DB->dbdefault . '\' AND `table_type` = \'BASE TABLE\' AND `table_name` LIKE \'glpi_logs\'',
