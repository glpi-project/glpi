...
class NotificationTargetSavedSearch_AlertTest extends DbTestCase
{
    public function testAddDataForTemplate()
    {
        ...
        $saved_searches_id = $saved_search->add([
            ...
            'itemtype' => 'Computer',
            'url' => 'http://localhost/front/computer.php?is_deleted=0&as_map=0&browse=0&criteria%5B0%5D%5Blink%5D=AND&criteria%5B0%5D%5Bfield%5D=view&criteria%5B0%5D%5Bsearchtype%5D=contains&criteria%5B0%5D%5Bvalue%5D=test&itemtype=Computer&start=0&sort%5B%5D=1&order%5B%5D=ASC',
        ]);
