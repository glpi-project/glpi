    ...
    public function testLogOperationOnAddAndDelete(): void
    {
        ...
        $expected_entries = [
            ...
            [
                ...
                'new_value'     => sprintf(
                    '%s (%s), %s (%s)',
                    htmlspecialchars($entity1->fields['completename']),
                    $entity1->fields['id'],
                    htmlspecialchars($profile1->fields['name']),
                    $profile1->fields['id'],
                ),
            ],
            [
                ...
                'new_value'     => sprintf(
                    '%s (%s), %s (%s)',
                    htmlspecialchars($user->fields['name']),
                    $user->fields['id'],
                    htmlspecialchars($entity1->fields['completename']),
                    $entity1->fields['id'],
                ),
            ...
            [
                ...
                'new_value'     => sprintf(
                    '%s (%s), %s (%s) (R)',
                    htmlspecialchars($entity2->fields['completename']),
                    $entity2->fields['id'],
                    htmlspecialchars($profile1->fields['name']),
                    $profile1->fields['id'],
                ),
            ...
            [
                ...
                'new_value'     => sprintf(
                    ...
                    htmlspecialchars($entity2->fields['completename']),
                    $entity2->fields['id'],
                    htmlspecialchars($profile2->fields['name']),
                    $profile2->fields['id'],
                ),
            ],
            [
