...
class TicketTask extends DbTestCase
{
    ...
    public function testUpdateMyTask()
    {
        ...
        $task_right = $this->createItem(ProfileRight::class, [
            'profiles_id' => $profile->getID(),
            'name' => 'task',
            'rights' => CommonITILTask::ADDMYTICKET,
        ]);
    ...
    {
        $this->createTaskAndAssertCanCreate('testAddOnMyTicket', CommonITILTask::ADDMYTICKET, '_users_id_requester');
    }
    ...
    public function testAddAsGroup()
    {
        ...
        $this->createItem(ProfileRight::class, [
            'profiles_id' => $profile->getID(),
            'name' => 'task',
            'rights' => CommonITILTask::ADDGROUPTICKET
        ]);
