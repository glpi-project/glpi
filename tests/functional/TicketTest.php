...
HTML,
    ...
    public function testTemplateUpdatesWhenCategoryChanges(): void
    {
        ...
        [$ticket_template1, $ticket_template2] = $this->createItems(
        ...
        $cat = $this->createItem(
            ...
            [
                ...
                'tickettemplates_id_demand'   => $ticket_template2->getID(),
                'tickettemplates_id_incident' => $ticket_template2->getID(),
                'is_request'                  => 1,
                'is_incident'                 => 1,
            ],
        );
        ...
        $ticket = $this->createItem(
            ...
            [
                ...
                'type'               => \Ticket::DEMAND_TYPE,
                'entities_id'        => 0,
                'tickettemplates_id' => $ticket_template1->getID(),
            ]
        );

        $this->assertEquals(
            $ticket_template1->getID(),
            $ticket->fields['tickettemplates_id'],
        );
        ...
        $ticket = $this->updateItem(
            ...
            $ticket->getID(),
            [
                'itilcategories_id' => $cat->getID(),
            ]
        );

        $this->assertEquals(
            $ticket_template2->getID(),
            $ticket->fields['tickettemplates_id'],
        );
    }
}
