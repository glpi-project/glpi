...
class KnowbaseItemParametersTest extends AbstractParametersTest
{
    public function testGetValues(): void
    {
        ...
        $this->assertEquals(
            [
                ...
                'name'   => 'kbi_testGetValues',
                'answer' => "test answer' \"testGetValues",
                'link'   => '<a href="/front/knowbaseitem.form.php?id=' . $kbi_id . '" data-bs-toggle="tooltip" data-bs-placement="bottom" title="kbi_testGetValues">kbi_testGetValues</a>',
            ],
            $values
        );
