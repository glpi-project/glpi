...
<REQUEST>
  ...
  <QUERY>INVENTORY</QUERY>
    ...
    public function testImportVirtualMachineWithoutHistory()
    {
        ...
        //get first ComputervirtualMachine and computer with fe040942-926a-e895-13f9-a37fc3607c14
        ...
        //get second ComputervirtualMachine and computer with c37f7ce8-af95-4676-b454-0959f2c5e162
    ...
    public function testImportVirtualMachineWithHistory()
    {
        $xml_source = "<?xml version=\"1.0\" encoding=\"UTF-8\" ?>
        <REQUEST>
          <CONTENT>
        ...
        $this->login();
        $conf = new \Glpi\Inventory\Conf();
        $this->boolean($conf->saveConf(['vm_as_computer' => 1, 'keep_vm_history' => 1]))->isTrue();
        $this->logout();
        ...
        //get first ComputervirtualMachine and computer with fe040942-926a-e895-13f9-a37fc3607c14
        //wich already exist and still available (is_delted = false)
        $firlst_vm = new \ComputerVirtualMachine();
        $this->boolean($firlst_vm->getFromDBByCrit([
            'uuid' => 'fe040942-926a-e895-13f9-a37fc3607c14',
            'computers_id' => $esx_id_first,
        ...
        //get second ComputervirtualMachine and computer with c37f7ce8-af95-4676-b454-0959f2c5e162
        //wich not exist from XMl (is_deleted = 1 from GLPI)
        $second_vm = new \ComputerVirtualMachine();
        $this->boolean($second_vm->getFromDBByCrit([
            'uuid' => 'c37f7ce8-af95-4676-b454-0959f2c5e162',
            'computers_id' => $esx_id_first,
