...
<REQUEST>
  ...
  <QUERY>INVENTORY</QUERY>
    ...
    public function testInventoryRemoved()
    {
        ...
        $this->integer(count($DB->request(['FROM' => Asset_PeripheralAsset::getTable(), 'WHERE' => ['itemtype_asset' => 'Computer', 'items_id_asset' => $computers_id, 'itemtype_peripheral' => 'Monitor']])))->isIdenticalTo(1);
        ...
        $this->integer(count($DB->request(['FROM' => Asset_PeripheralAsset::getTable(), 'WHERE' => ['itemtype_asset' => 'Computer', 'items_id_asset' => $computers_id, 'itemtype_peripheral' => 'Monitor']])))->isIdenticalTo(0);
    }
}
