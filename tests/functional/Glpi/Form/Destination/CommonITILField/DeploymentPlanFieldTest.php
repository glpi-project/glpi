...
final class DeploymentPlanFieldTest extends DbTestCase
{
    use FormTesterTrait;
    ...
    public function testContentWithoutTagsForChange(): void
    {
        ...
        $this->assertEquals(
            "No deployment plan",
            $change->fields['rolloutplancontent']
        );
    }
    ...
    public function testContentWithTagsForChange(): void
    {
        ...
        $this->setDestinationFieldConfig(
            $form,
            DeploymentPlanField::getKey(),
            "Deployment plan will be done by: {$tags[0]->html} {$tags[1]->html}"
        );
        ...
        // Assert: the impact field should contain the raw string we configured
        $this->assertEquals(
            "Deployment plan will be done by: John Smith",
            $change->fields['rolloutplancontent']
        );
    }
}
