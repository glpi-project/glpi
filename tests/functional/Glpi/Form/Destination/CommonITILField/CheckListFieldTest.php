...
final class CheckListFieldTest extends DbTestCase
{
    use FormTesterTrait;
    ...
    public function testContentWithoutTagsForChange(): void
    {
        ...
        $this->assertEquals(
            "No check list",
            $change->fields['checklistcontent']
        );
    }
    ...
    public function testContentWithTagsForChange(): void
    {
        ...
        $this->setDestinationFieldConfig(
            $form,
            CheckListField::getKey(),
            "Check list will be done by: {$tags[0]->html} {$tags[1]->html}"
        );
        ...
        // Assert: the impact field should contain the raw string we configured
        $this->assertEquals(
            "Check list will be done by: John Smith",
            $change->fields['checklistcontent']
        );
    }
}
