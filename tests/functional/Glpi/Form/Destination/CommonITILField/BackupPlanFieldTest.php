...
final class BackupPlanFieldTest extends DbTestCase
{
    use FormTesterTrait;
    ...
    public function testContentWithoutTagsForChange(): void
    {
        ...
        $this->assertEquals(
            "No backup plan",
            $change->fields['backoutplancontent']
        );
    }
    ...
    public function testContentWithTagsForChange(): void
    {
        ...
        $this->setDestinationFieldConfig(
            $form,
            BackupPlanField::getKey(),
            "Backup plan will be done by: {$tags[0]->html} {$tags[1]->html}"
        );
        ...
        // Assert: the impact field should contain the raw string we configured
        $this->assertEquals(
            "Backup plan will be done by: John Smith",
            $change->fields['backoutplancontent']
        );
    }
}
