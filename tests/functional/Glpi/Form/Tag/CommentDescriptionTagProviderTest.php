...
final class CommentDescriptionTagProviderTest extends DbTestCase
{
    use FormTesterTrait;
    ...
    {
        $tagProvider = new CommentDescriptionTagProvider();
    ...
    private function checkGetTagContentForValue(
        ...
        $tag_provider = new CommentDescriptionTagProvider();
