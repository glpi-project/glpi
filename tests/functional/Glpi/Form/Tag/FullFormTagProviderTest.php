...
final class FullFormTagProviderTest extends DbTestCase
{
    ...
    public function testGetTagContentForValueMatchesAutoGeneratedContent(): void
    {
        ...
        $expected_content = (new ContentField())
            ->getAutoGeneratedConfig($form, $answers)
            ->getValue()
        ;

        $this->assertNotEmpty($computed_content);
