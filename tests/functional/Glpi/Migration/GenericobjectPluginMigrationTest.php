    ...
    public function testProcessMigration(): void
    {
        ...
        $expected_definitions = [
            ...
            [
                ...
                'translations'   => [],
                'fields_display' => [
                    ['key' => 'template_name', 'order' => 0, 'field_options' => []],
                    ['key' => 'name', 'order' => 1, 'field_options' => []],
                    ['key' => 'serial', 'order' => 2, 'field_options' => []],
                    ['key' => 'otherserial', 'order' => 3, 'field_options' => []],
                    ['key' => 'locations_id', 'order' => 4, 'field_options' => []],
                    ['key' => 'states_id', 'order' => 5, 'field_options' => []],
                    ['key' => 'users_id', 'order' => 6, 'field_options' => []],
                    ['key' => 'groups_id', 'order' => 7, 'field_options' => []],
                    ['key' => 'manufacturers_id', 'order' => 8, 'field_options' => []],
                    ['key' => 'users_id_tech', 'order' => 9, 'field_options' => []],
                    ['key' => 'comment', 'order' => 10, 'field_options' => []],
                    ['key' => 'custom_computers_id_host', 'order' => 11, 'field_options' => []],
                    ['key' => 'custom_config_str', 'order' => 12, 'field_options' => []],
                    ['key' => 'contact', 'order' => 13, 'field_options' => []],
                    ['key' => 'contact_num', 'order' => 14, 'field_options' => []],
                    ['key' => 'custom_creationdate', 'order' => 15, 'field_options' => []],
                    ['key' => 'custom_count', 'order' => 16, 'field_options' => []],
                    ['key' => 'custom_expirationdate', 'order' => 17, 'field_options' => []],
                    ['key' => 'groups_id_tech', 'order' => 18, 'field_options' => []],
                    ['key' => 'custom_other', 'order' => 19, 'field_options' => []],
                    ['key' => 'custom_dropdowns_dropdowns_id_smartphonecategory', 'order' => 20, 'field_options' => []],
                    ['key' => 'assets_assetmodels_id', 'order' => 21, 'field_options' => []],
                    ['key' => 'assets_assettypes_id', 'order' => 22, 'field_options' => []],
                    ['key' => 'custom_url', 'order' => 23, 'field_options' => []],
                    ['key' => 'custom_assets_assets_id_tablet', 'order' => 24, 'field_options' => []],
                    ['key' => 'custom_dropdowns_dropdowns_id_bar', 'order' => 25, 'field_options' => []],
                    ['key' => 'custom_dropdowns_dropdowns_id_foo', 'order' => 26, 'field_options' => []],
        ...
        $expected_definitions = [
            [
                ...
                'comment'       => null,
                'is_active'     => true,
                'profiles'      => \array_fill_keys([1, 2, 3, 4, 5, 6, 7, 8, 9], 23),
                'translations'  => [],
