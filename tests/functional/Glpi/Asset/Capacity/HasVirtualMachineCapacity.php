...
class HasVirtualMachineCapacity extends CapacityTestCase
{
    /**
    ...
    public function testCapacityActivation(): void
    {
        ...
        foreach ($has_capacity_mapping as $classname => $has_capacity) {
            ...
            if ($has_capacity) {
                $this->array($CFG_GLPI['itemvirtualmachines_types'])->contains($classname);
            } else {
                $this->array($CFG_GLPI['itemvirtualmachines_types'])->notContains($classname);
            }
            ...
            if ($has_capacity) {
                $this->array($item->defineAllTabs())->hasKey('ItemVirtualMachine$1');
            } else {
                $this->array($item->defineAllTabs())->notHasKey('ItemVirtualMachine$1');
            }
    ...
    public function testCapacityDeactivation(): void
    {
        ...
        $this->object(ItemVirtualMachine::getById($av_item_1->getID()))->isInstanceOf(ItemVirtualMachine::class);
        ...
        $this->object(ItemVirtualMachine::getById($av_item_2->getID()))->isInstanceOf(ItemVirtualMachine::class);
        ...
        $this->array($CFG_GLPI['itemvirtualmachines_types'])->contains($classname_1);
        $this->array($CFG_GLPI['itemvirtualmachines_types'])->contains($classname_2);
        ...
        $this->boolean(ItemVirtualMachine::getById($av_item_1->getID()))->isFalse();
        ...
        $this->array($CFG_GLPI['itemvirtualmachines_types'])->notContains($classname_1);
    ...
    public function testCloneAsset()
    {
        ...
        $this->array(getAllDataFromTable(ItemVirtualMachine::getTable(), [
