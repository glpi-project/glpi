...
class HasImpactCapacity extends DbTestCase
{
    ...
    public function testCapacityDeactivation(): void
    {
        ...
        $this->object(ImpactItem::getById($impact_item_1->getID()))->isInstanceOf(ImpactItem::class);
        $this->object(ImpactItem::getById($impact_item_2->getID()))->isInstanceOf(ImpactItem::class);
        ...
        $this->boolean(ImpactItem::getById($impact_item_1->getID()))->isFalse();
