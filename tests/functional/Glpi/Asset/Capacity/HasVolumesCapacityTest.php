...
class HasVolumesCapacityTest extends DbTestCase
{
    use CapacityUsageTestTrait;

    protected function getTargetCapacity(): string
    {
        return HasVolumesCapacity::class;
    }
    ...
    public function testCapacityActivation(): void
    {
        ...
        foreach ($has_capacity_mapping as $classname => $has_capacity) {
            ...
            if ($has_capacity) {
                $this->assertContains($classname, $CFG_GLPI['disk_types']);
            } else {
                $this->assertNotContains($classname, $CFG_GLPI['disk_types']);
            }
            ...
            if ($has_capacity) {
                ...
                $this->assertArrayNotHasKey('Item_Disk$1', $item->defineAllTabs());
            }
    ...
    public function testCapacityDeactivation(): void
    {
        ...
        $this->assertInstanceOf(Item_Disk::class, Item_Disk::getById($disk_item_1->getID()));
        ...
        $this->assertInstanceOf(Item_Disk::class, Item_Disk::getById($disk_item_2->getID()));
        ...
        $this->assertContains($classname_1, $CFG_GLPI['disk_types']);
        $this->assertContains($classname_2, $CFG_GLPI['disk_types']);
        ...
        $this->assertFalse(Item_Disk::getById($disk_item_1->getID()));
        ...
        $this->assertNotContains($classname_1, $CFG_GLPI['disk_types']);
    ...
    public function testCloneAsset()
    {
        $definition = $this->initAssetDefinition(
            capacities: [new Capacity(name: HasVolumesCapacity::class)]
        );
