...
class KnowbaseItem_Item extends DbTestCase
{
    ...
    public function testGetTabNameForItem()
    {
        ...
        $this->string($name)->isIdenticalTo("<span><i class='ti ti-lifebuoy me-2'></i>Associated elements</span> <span class='badge bg-secondary text-secondary-fg'>3</span>");
        ...
        $this->string($name)->isIdenticalTo("<span><i class='ti ti-lifebuoy me-2'></i>Knowledge base</span> <span class='badge bg-secondary text-secondary-fg'>2</span>");
