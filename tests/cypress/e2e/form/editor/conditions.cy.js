    ...
    it('can apply all supported conditions types', () => {
        ...
        getAndFocusQuestion('Test subject').within(() => {
            ...
            checkThatConditionExist(
                4,
                'And',
                'Questions - My datetime question',
                'Is greater than',
                '2021-01-01T15:40',
                'date',
            );
            ...
            checkThatConditionExist(
                6,
                'And',
                'Questions - My request type question',
                'Is equal to',
                'Request',
                'dropdown',
            );
            ...
            checkThatConditionExist(
                8,
                'And',
                'Questions - My checkbox question',
                'Contains',
                ['Option 2', 'Option 4'],
                'dropdown_multiple',
            );
            checkThatConditionExist(
                9,
                'And',
                'Questions - My single value dropdown question',
                'Is not equal to',
                'Option 2',
                'dropdown',
            );
            checkThatConditionExist(
                10,
                'And',
                'Questions - My multiple values dropdown question',
                'Is not equal to',
                ['Option 1', 'Option 2'],
                'dropdown_multiple',
            );
            checkThatConditionExist(
                11,
                'And',
                'Questions - My requester question',
                'Is equal to',
                'e2e_tests',
                'dropdown',
            );
            checkThatConditionExist(
                12,
                'And',
                'Questions - My observer question',
                'Is equal to',
                'e2e_tests',
                'dropdown',
            );
            checkThatConditionExist(
                13,
                'And',
                'Questions - My assignee question',
                'Is equal to',
                'e2e_tests',
                'dropdown',
            );
