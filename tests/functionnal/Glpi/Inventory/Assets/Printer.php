...
<REQUEST>
  ...
  <QUERY>INVENTORY</QUERY>
    ...
    public function testSnmpPrinter()
    {
        ...
        //no remot_addr from netinventory
        $this->variable($printer->fields['remote_addr'])->isNull();
    ...
    public function testSnmpPrinterRemoteAddrOnDiscovery()
    {
        /**
        ...
        $this->string($printer->fields['remote_addr'])->isIdenticalTo('10.100.51.207');
        ...
        $printer = new \Printer();
        $this->boolean($printer->getFromDbByCrit(['name' => 'CLPSF99', 'serial' => 'E1234567890']))->isTrue();
        $this->string($printer->fields['remote_addr'])->isIdenticalTo('10.100.49.125');
    ...
    public function testSnmpPrinterRemoteAddrOnInventory()
    {
        /**
         * Check if IP node is set as remote_addr from discovery
         */
    ...
    public function testSnmpPrinterManagementPortNeverCreated()
    {
        /**
         * This check if management port is never created
         */
        $date_now = date('Y-m-d H:i:s');
        $_SESSION['glpi_currenttime'] = $date_now;
