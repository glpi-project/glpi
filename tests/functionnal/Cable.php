...
class Cable extends DbTestCase {
   ...
   public function testAddCable() {
      ...
      $cable_id = $cable->add([
         ...
         'entities_id'           => $computer1->fields['entities_id'],
         'is_recursive'          => 0,
         'itemtype_rear'         => 'Computer',
         'itemtype_front'        => 'Computer',
         'items_id_rear'         => $computer1->getID(),
         'items_id_front'        => $computer2->getID(),
         'socketmodels_id_rear'  => $socketModel1_id,
         'front_socketmodels_id' => $socketModel2_id,
         'sockets_id_rear'       => $socket1_id,
         'sockets_id_front'      => $socket2_id,
