   ...
   public function testStore() {
      ...
      $this->integer(
         $creds->add([
            ...
            'type' => \Glpi\Agent\Credentials\AbstractCredential::LOGIN_TYPE,
            'agenttasks_id' => $tid,
            'login' => 'glpi',
            'password' => 'Th3 GLP1 P@$$W0rD'
         ])
      )->isGreaterThan(0);
      ...
      $dbcred = $iterator->next();
      $this->string($dbcred['name'])->isIdenticalTo('A test credential');
      $this->integer((int)$dbcred['type'])->isIdenticalTo(\Glpi\Agent\Credentials\AbstractCredential::LOGIN_TYPE);
      $this->string($dbcred['credentials'])->notCOntains('glpi');
   }
