   ...
   // Instantiation properties
    ...
    public static function getGlobalInstantiationNetworkPortDisplayOptions()
    {
        return [
            ...
            'virtual_ports' => [
                'name'    => __('Virtual ports'),
                'default' => false
            ],
            'port_opposite' => [
                'name'    => __('Opposite link'),
                'default' => false
            ]
        ];
    }
     ...
     * @param HTMLTableSuperHeader|null $internet_super HTMLTableSuperHeader object for the internet sub part (default NULL)
     * @param HTMLTableHeader|null $father HTMLTableHeader object (default NULL)
    ...
    public function getInstantiationHTMLTableHeaders(
        ...
        if (($this->haveMAC) && ($display_options['mac'])) {
            $group->addHeader('MAC', __s('MAC'), $super, $father);
        }
     ...
     * @param NetworkPort   $netport  NetworkPort object (contains item)
     * @param HTMLTableRow  $row      HTMLTableRow object
     * @param HTMLTableCell|null $father   HTMLTableCell object (default NULL)
     * @param array         $options  array of possible options:
     *       - 'dont_display' : array of the elements that must not be display
     *       - 'withtemplate' : integer withtemplate param
     *
    ...
    public function getInstantiationHTMLTableWithPeer(
        ...
        $connect_cell_value = [
            [
                'function'   => ['NetworkPortInstantiation::showConnection'],
...
TWIG, $twig_params);
    ...
    /**
     * Display the attached NetworkPort
     *
