...
class NotificationTargetTicket extends NotificationTargetCommonITILObject
{
    ...
    /**
     * @param Ticket $item
     * @param array $options{validation_id?: int, additionnaloption: array{usertype: \NotificationTarget::ANONYMOUS_USER|\NotificationTarget::EXTERNAL_USER|\NotificationTarget::GLPI_USER} }
     * @param bool $simple
     *
     * @return array
     */
