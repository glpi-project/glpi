...
class MailCollector extends CommonDBTM
{
    ...
    public static function getAdditionalMenuLinks()
    {
        ...
        if (OAuthApplication::canView()) {
            $links["<i class='" . htmlescape(OAuthApplication::getIcon()) . "' aria-hidden='true'></i>" . __s('OAuth Applications')]
    ...
    public function showForm($ID, array $options = [])
    {
        ...
        foreach (OAuthApplication::getActiveApplications() as $app) {
            $protocol_choices['/' . OAuthApplication::PROTOCOL_PREFIX . $app->getID()] = $app->fields['name'];
        }
