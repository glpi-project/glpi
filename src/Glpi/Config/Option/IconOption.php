...
class IconOption extends ConfigOption
{
    public function __construct(
        ...
        parent::__construct($scopes, $section, $name, $label, InputType::DROPDOWN_ICON, [], $context);
    }
    ...
    public function renderInput(ConfigScope $scope, array $scope_params = [], array $input_params = []): void
    {
        ...
        {{ fields.dropdownIcon(name, value, label, field_options) }}
TWIG;
        $name = $this->getName();
