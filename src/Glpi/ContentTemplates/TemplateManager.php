...
class TemplateManager
{
    ...
    public static function renderContentForCommonITIL(
        ...
        foreach ($PLUGIN_HOOKS[Hooks::GET_CONTENT_TEMPLATE_VALUE] as $plugin => $hook_callable) {
            $plugin_parameters = Plugin::doOneHook($plugin, Hooks::GET_CONTENT_TEMPLATE_VALUE, ['NodeName' => $parameters->getDefaultNodeName(), 'id' => $itil_item->fields['id']]);
