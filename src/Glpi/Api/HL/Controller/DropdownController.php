        ...
        $schemas['ITILCategory'] = [
            ...
            'properties' => [
                ...
                'ticket_request_template' => self::getDropdownTypeSchema(
                    class: TicketTemplate::class,
                    field: 'tickettemplates_id_request',
                    full_schema: 'TicketTemplate'
                ) + ['x-version-introduced' => '2.2.0'],
...
EOT,
        ...
        $schemas['CloseTime'] = [
            ...
            'properties' => [
                ...
                'entity' => self::getDropdownTypeSchema(class: Entity::class, full_schema: 'Entity'),
                'is_recursive' => ['type' => Doc\Schema::TYPE_BOOLEAN],
                'date_begin' => ['type' => Doc\Schema::TYPE_STRING, 'format' => Doc\Schema::FORMAT_STRING_DATE_TIME, 'x-field' => 'begin_date'],
                'date_end' => ['type' => Doc\Schema::TYPE_STRING, 'format' => Doc\Schema::FORMAT_STRING_DATE_TIME, 'x-field' => 'end_date'],
