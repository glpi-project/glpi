...
final class ManagementController extends AbstractController
{
    ...
    #[Doc\Route(
        ...
        parameters: [
            new Doc\Parameter(name: 'HTTP_IF_NONE_MATCH', schema: new Schema(type: Schema::TYPE_STRING), location: Parameter::LOCATION_HEADER),
            new Doc\Parameter(name: 'HTTP_IF_MODIFIED_SINCE', schema: new Schema(type: Schema::TYPE_STRING), location: Parameter::LOCATION_HEADER),
        ],
        responses: [
