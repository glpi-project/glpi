 ...
 * this one.
 */
abstract class AbstractFormTranslationSerializer
{
    ...
    protected function serialize(FormTranslationsSpecification $specification): string
    {
    ...
    protected function deserialize(string $json): FormTranslationsSpecification
    {
        return $this->serializer->deserialize(
            $json,
            FormTranslationsSpecification::class,
            'json'
        );
    }
}
