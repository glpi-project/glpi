...
interface ConfigFieldInterface
{
     ...
     * @param Form $form
     *
     * @return JsonConfigInterface|null (null if not supported)
     */
    public function getAutoGeneratedConfig(Form $form): ?JsonConfigInterface;
    ...
    /** @return class-string<JsonConfigInterface>  */
