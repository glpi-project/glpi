...
final readonly class Step2Controller implements Controller
{
    #[Route("/Form/Import/Step/2", name: "form_import_step_2", methods: "POST")]
    public function __invoke(Request $request): Response
    {
        ...
        return new GlpiPageResponse("pages/admin/form/import/step2.html.twig", [
