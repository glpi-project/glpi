...
final class LanguageRegistry
{
    ...
    private static function definitions(): array
    {
        return [
            ...
            new Language('es_MX', 'Español (México)', english_name: 'spanish'),
            ...
            new Language('nl_BE', 'Vlaams', english_name: 'flemish'),
            ...
            new Language('ko_KR', '한국어', english_name: 'korean', plural_number: 1),
            new Language('zh_HK', '繁體中文（香港）', jquery_code: 'zh-HK', english_name: 'chinese'),
