    ...
    private function prepareInput(&$input)
    {
        ...
        if ($question_type) {
            if (isset($input['default_value'])) {
                $input['default_value'] = (new $question_type())->formatDefaultValueForDB($input['default_value']);
            }
            ...
            $is_extra_data_valid = (new $question_type())->validateExtraDataInput($extra_data);
