...
abstract class CommonItilObject_Item extends CommonDBRelation
{
     ...
     * @since 0.83
     *
     * @param object $obj object holding the future item of object to add
     * @param string $type of the object to add
     *
     * @return boolean
     **/
    public static function canAddRelatedItem($obj, $type = '')
    {
        return true;
    }
    ...
    public static function isPossibleToAssignType($itemtype)
    {
        if (method_exists(static::$itemtype_1, 'isPossibleToAssignType')) {
            return static::$itemtype_1::isPossibleToAssignType($itemtype);
        }
    ...
    public function canCreateItem()
    {
        ...
        if (
            $obj->getFromDB($this->fields[static::$items_id_1])
     ...
     * @return void
     **/
    public static function itemAddForm($obj, $options = [])
    {
    ...
    public static function showForObject($obj, $options = [])
    {
        ...
        if (!$obj->can($instID, READ) || !static::validateObjectType($obj)) {
            return false;
        }
    ...
    public static function showListForItem(CommonDBTM $item, $withtemplate = 0, $options = [])
    {
        ...
        if (
            !Session::haveRightsOr(
                static::$itemtype_1::$rightname,
                [
                    static::$itemtype_1::READALL,
                    static::$itemtype_1::READMY,
                    static::$itemtype_1::READASSIGN,
                    CREATE
                ]
            )
        ) {
    ...
    public static function dropdownMyDevices($userID = 0, $entity_restrict = -1, $itemtype = 0, $items_id = 0, $options = [])
    {
        ...
        if (
            ...
            // keep objiteminformation.php because it is generic on my device / device
            Ajax::updateItemOnSelectEvent(
                "dropdown_my_items$rand",
                "item_" . static::$itemtype_1 . "_selection_information$rand",
     ...
     * @return array
     */
    public static function getUsedItems($obj_id)
    {
     ...
     * @param MassiveAction $ma massive action to process
     * @param CommonDBTM $item item on which the ma should be processed (to get the type)
     * @param array $ids
     **/
