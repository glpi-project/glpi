...
class FileOption extends ConfigOption
{
    public function __construct(
        ...
        string $name,
        string $label,
        InputType $input_type = InputType::FILE,
        string $context = 'core'
    ) {
...
TWIG;
        ...
        $template_content .= match ($this->getType()) {
            InputType::FILE => '{{ fields.fileField(name, value, label, field_options) }}',
            InputType::IMAGE => '{{ fields.imageField(name, value, label, field_options) }}',
            InputType::IMAGE_GALLERY => '{{ fields.imageGalleryField(name, value, label, field_options) }}'
        };
