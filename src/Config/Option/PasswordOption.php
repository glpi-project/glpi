...
class PasswordOption extends ConfigOption
{
    public function __construct(
        ...
        parent::__construct($scopes, $section, $name, $label, InputType::PASSWORD, [], $context);
    }
    ...
    public function renderInput(ConfigScope $scope, array $scope_params = [], array $input_params = []): void
    {
        ...
        {{ fields.passwordField(name, value, label, field_options) }}
TWIG;
        $name = $this->getName();
