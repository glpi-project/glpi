...
define('GLPI_VERSION', '12.0.0-rc1');
...
// Path to the TCPDF/tc-lib-pdf font assets (JSON definitions generated by
// `tecnickcom/tc-lib-pdf-font`). Since TCPDF 7.0, fonts are no longer bundled
// and must be generated (see the fonts build step)
define('K_PATH_FONTS', GLPI_ROOT . '/vendor/tecnickcom/tc-lib-pdf-font/target/fonts');
