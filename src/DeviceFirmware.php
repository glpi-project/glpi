...
class DeviceFirmware extends CommonDevice
{
    ...
    public static function rawSearchOptionsToAdd($itemtype, $main_joinparams)
    {
        ...
        $tab[] = [
            ...
            'table'              => 'glpi_devicefirmwaretypes',
            'field'              => 'name',
            'name'               => __('firmware: firmware type'),
            'massiveaction'      => false,
            'datatype'           => 'dropdown',
            'joinparams'         => [
                'beforejoin' => [
        ...
        $tab[] = [
            ...
            'table'              => 'glpi_devicefirmwaremodels',
            'field'              => 'name',
            'name'               => __('firmware: firmware model'),
            'massiveaction'      => false,
            'datatype'           => 'dropdown',
            'joinparams'         => [
                'beforejoin' => [
        ...
        $tab[] = [
            ...
            'field'              => 'name',
            'name'               => __('firmware: manufacturers'),
            'massiveaction'      => false,
            'datatype'           => 'dropdown',
            'joinparams'         => [
                'beforejoin' => [
