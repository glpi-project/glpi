                            ...
                            new \QueryExpression(
                                QueryFunction::dateDiff(
                                    expression1: QueryFunction::addDate(
                                        date: $DB::quoteName('glpi_ticketsatisfactions.date_begin'),
                                        interval: $DB::quoteName('glpi_entities.inquest_duration'),
                                        interval_unit: 'DAY'
                                    ),
