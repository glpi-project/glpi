...
class Ticket extends CommonITILObject implements DefaultSearchRequestInterface
{
    ...
    {
        $this->failsWithOlaRemovedFields($input); // td à la fois fails et trarsform 2 lignes plus bas ?
    ...
    {
        $this->failsWithOlaRemovedFields($input); // todo même remarque fails ici et transform plus bas
...
JAVASCRIPT;
    ...
    public function processRules(int $condition, array &$input, int $entid = -1): void
    {
        ...
        // @todo pas besoin de if (!isset($input['_skip_sla_assign']) || $input['_skip_sla_assign'] === false) ?
