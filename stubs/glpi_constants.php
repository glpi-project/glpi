...
(static function () {
    ...
    define('GLPI_SERVERSIDE_URL_PRIVATE_NETWORK_EXEMPTIONS', $random_val([['Glpi\\System\\Status\\StatusChecker'], ['Glpi\\System\\Status\\StatusChecker', 'Glpi\\Something\\Else']]));
