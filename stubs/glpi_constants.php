...
define('ALLSTANDARDRIGHT', null);
define('CREATE', null);
define('DAY_TIMESTAMP', null);
define('DELETE', null);
define('ERROR', null);
define('ERROR_ALREADY_DEFINED', null);
define('ERROR_COMPAT', null);
define('ERROR_NOT_FOUND', null);
define('ERROR_ON_ACTION', null);
define('ERROR_RIGHT', null);
define('GLPIKEY', null);
define('GLPI_CONFIG_DIR', null);
define('GLPI_I18N_DIR', null);
define('GLPI_MAX_PHP', null);
define('GLPI_MIN_PHP', null);
define('GLPI_SCHEMA_VERSION', null);
define('GLPI_VERSION', null);
define('GLPI_YEAR', null);
define('HOUR_TIMESTAMP', null);
define('INFO', null);
define('MAIL_MAIL', null);
define('MAIL_SMTP', null);
define('MAIL_SMTPOAUTH', null);
define('MAIL_SMTPS', null);
define('MAIL_SMTPSSL', null);
define('MAIL_SMTPTLS', null);
define('MANAGEMENT_GLOBAL', null);
define('MANAGEMENT_UNITARY', null);
define('MINUTE_TIMESTAMP', null);
define('MONTH_TIMESTAMP', null);
define('NOT_AVAILABLE', null);
define('PURGE', null);
define('READ', null);
define('READNOTE', null);
define('READ_ASSIGNED', null);
define('READ_OWNED', null);
define('UNLOCK', null);
define('UPDATE', null);
define('UPDATENOTE', null);
define('UPDATE_ASSIGNED', null);
define('UPDATE_OWNED', null);
define('WARNING', null);
define('WEEK_TIMESTAMP', null);
