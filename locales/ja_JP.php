...
$LANG['common'][40]="このアイテムを非公開にしてよろしいですか?"; 
...
$LANG['crontask'][0]="予定済みタスク"; 
$LANG['crontask'][1]="OCS Inventory NGを同期"; 
...
$LANG['crontask'][43]="待機中のタスクなし"; 
$LANG['crontask'][44]="終了タスク（一部対応）"; 
$LANG['crontask'][45]="終了タスク（完了）"; 
$LANG['crontask'][46]="終了タスク（未対応）"; 
...
$LANG['entity'][17]="管理設定終了"; 
$LANG['entity'][18]="管理者が解決済みにしたチケット"; 
...
$LANG['help'][23]="先頭文字を入力して下さい（連絡先、アイテム名、シリアル番号もしくはアセット番号）"; 
...
$LANG['ldap'][45]="ユーザーがディレクトリから削除されたときのアクション"; 
$LANG['ldap'][46]="権限を削除"; 
$LANG['ldap'][47]="ゴミ箱へ"; 
$LANG['ldap'][48]="LDAPユーザーを削除"; 
...
$LANG['mailgate'][14]="GLPI依頼者"; 
$LANG['mailgate'][15]="E-mailサイズ"; 
$LANG['mailgate'][16]="Re:"; 
...
$LANG['ocsconfig'][58]="リンクにより自動的にGLPIコンピュータをOCSに関連付けます。 このオプションは手動リンク中のアカウントで、かつ同期スクリプトを用いる場合にのみ有効です。"; 
...
$LANG['reservation'][3]="無効にするにはクリック"; 
...
$LANG['rulesengine'][136]="発行者のアドレス"; 
$LANG['rulesengine'][137]="受領者のアドレス"; 
$LANG['rulesengine'][138]="LDAP条件"; 
$LANG['rulesengine'][139]="条件が未定義"; 
$LANG['rulesengine'][140]="抽出条件の追加"; 
$LANG['rulesengine'][141]="ルールが未確認"; 
$LANG['rulesengine'][142]="インポートされていないE-mailのリスト"; 
$LANG['rulesengine'][143]="ユーザーグループ"; 
...
$LANG['setup'][130]="タスクログが保存される日数（通常は0）"; 
...
$LANG['setup'][613]="権限のないLDAPユーザーを追加する"; 
...
$LANG['tracking'][9]="ヘルプデスクへのデフォルト依頼元"; 
$LANG['tracking'][10]="メール受信者へのデフォルト依頼元"; 
...
$LANG['tracking'][39]="ヘルプデスクインターフェースで表示"; 
