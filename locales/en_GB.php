...
$LANG['log'][46]="Failed"; 
$LANG['log'][48]="adding user to group"; 
...
$LANG['setup'][122]="Dynamic display - Maximum number of items viewed"; 
$LANG['setup'][123]="Don't use dynamic display if the number of items is less than (0=never)"; 
...
$LANG['setup'][130]="Number of days this action logs are stored (0 for always)"; 
