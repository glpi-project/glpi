...
$LANG['backup'][17]="Удалить этот файл"; 
$LANG['backup'][18]="Резервирование базы данных"; 
...
$LANG['bookmark'][6]="Применить по умолчанию"; 

$LANG['buttons'][0]="Поиск"; 
$LANG['buttons'][2]="Отправить"; 
$LANG['buttons'][3]="Назначать"; 
...
$LANG['buttons'][17]="Инвертировать отмеченное"; 
...
$LANG['cartridges'][33]="Б/У картриджи"; 
...
$LANG['central'][1]="это центральная панель."; 
...
$LANG['central'][16]="Приостановленные заявки для ваших групп"; 
...
$LANG['common'][10]="Материально ответственный инженер"; 
...
$LANG['common'][39]="Дублировать элемент на каждое соединение"; 
$LANG['common'][40]="Вы хотите разглобализировать этот объект?"; 
$LANG['common'][41]="Оповещения на Email"; 
...
$LANG['common'][55]="Действительно удалить этот элемент?"; 
...
$LANG['connect'][16]="Внимание! Следующие два элемента не совпадают"; 
...
$LANG['document'][34]="Создать папку"; 
...
$LANG['financial'][79]="С 'третьей' стороны"; 
...
$LANG['help'][40]="Нет названия заявки, заполните."; 
...
$LANG['joblist'][18]="Обрабатываемая (назначена)"; 
$LANG['joblist'][19]="Обрабатываемая(запланирована)"; 
$LANG['joblist'][21]="Обрабатываемая"; 
$LANG['joblist'][24]="Не закрыто"; 
$LANG['joblist'][25]="Старые"; 
$LANG['joblist'][26]="Ожидающие решения"; 
$LANG['joblist'][27]="Email для решения"; 
...
$LANG['knowbase'][24]="Доступ к Часто Задаваемым Вопросам (ЧЗВ)"; 
...
$LANG['ldap'][33]="Разыменовываются во время поиска (но не когда размещается)"; 
$LANG['ldap'][34]="Разыменовываются при размещении (но не при поиске)"; 
...
$LANG['log'][20]="объект добавлен"; 
$LANG['log'][21]="обновить объект"; 
$LANG['log'][22]="объект удален"; 
$LANG['log'][23]="объект восстановлен"; 
$LANG['log'][24]="объект очищен"; 
$LANG['log'][26]="объект отсоединен"; 
$LANG['log'][27]="объект подключен"; 
$LANG['log'][28]="компоненты изменены"; 
$LANG['log'][30]="назначен тип"; 
$LANG['log'][31]="удален тип"; 
$LANG['log'][32]="добавлена связь с объектом"; 
$LANG['log'][33]="удалена связь с объектом"; 
$LANG['log'][34]="добавлена связь с поставщиком"; 
$LANG['log'][35]="удалена связь с поставщиком"; 
$LANG['log'][36]="добавлена связь с контактом"; 
$LANG['log'][37]="удалена связь с контактом"; 
$LANG['log'][38]="связи"; 
$LANG['log'][39]="типы документов"; 
$LANG['log'][40]="IP соединения"; 
...
$LANG['log'][49]="удаление пользователя из группы"; 
$LANG['log'][55]="Соединения"; 
$LANG['log'][58]="Резервирование"; 
$LANG['log'][59]="Cron"; 
$LANG['log'][60]="предмет локализирован"; 
$LANG['log'][61]="добавления пользователя в организацию"; 
$LANG['log'][62]="полное удаление пользователя"; 
$LANG['log'][63]="организация"; 
$LANG['log'][64]="изменение примечания"; 
$LANG['log'][65]="правило"; 
$LANG['log'][66]="Безопасность"; 
$LANG['log'][67]="изменение примечаний"; 
$LANG['log'][70]="добавлен сетевой порт"; 
$LANG['log'][71]="добавлено несколько сетевых портов"; 
...
$LANG['log'][90]="убрать один картридж"; 
...
$LANG['log'][97]="закончились расходные для пользователей"; 
...
$LANG['login'][13]="Поле пароля пустое"; 
...
$LANG['login'][33]="Аутентификация на IMAP/POP сервера"; 

$LANG['mailgate'][0]="Аккаунт сбора почты"; 
$LANG['mailgate'][1]="Добавить аккаунт для сбора почты"; 
...
$LANG['mailing'][33]="Внимание Картриджи"; 
$LANG['mailing'][34]="Порог сигнала тревоги достигнут для типа картриджа:"; 
$LANG['mailing'][35]="Порог сигнала тревоги достигнут для этого типа расходных:"; 
$LANG['mailing'][36]="Внимание Расходные Материалы"; 
$LANG['mailing'][37]="Контракт: зафиксировано уведомление на время:"; 
$LANG['mailing'][38]="Истёкшие договора:"; 
$LANG['mailing'][39]="Внимание Договора"; 
$LANG['mailing'][40]="Гарантия на устройство закончилась:"; 
$LANG['mailing'][41]="Предупреждение по финансовой информации"; 
$LANG['mailing'][42]="Изменение почасовой оплаты"; 
$LANG['mailing'][43]="Изменение фиксированной стоимости"; 
$LANG['mailing'][44]="Изменение материальных затрат"; 
$LANG['mailing'][45]="Изменение заголовка заявки"; 
$LANG['mailing'][46]="Изменение описания заявки"; 
$LANG['mailing'][47]="Ошибка отправки email"; 
$LANG['mailing'][48]="Изменена дата открытия"; 
$LANG['mailing'][49]="Изменена дата закрытия"; 
$LANG['mailing'][50]="Изменение заказчика заявки"; 
$LANG['mailing'][51]="Окончание лицензии :"; 
$LANG['mailing'][52]="Предупреждение по лицензии"; 
...
$LANG['Menu'][12]="Файлы данных"; 
$LANG['Menu'][13]="Статистики"; 
...
$LANG['ocsconfig'][19]="Единица импорта по серийному номеру"; 
...
$LANG['ocsconfig'][41]="Журнал записей"; 
...
$LANG['ocsconfig'][51]="состояние разъединено"; 
...
$LANG['ocsng'][31]="Нет блокированных мониторов"; 
$LANG['ocsng'][32]="Заблокированное устройство(а)"; 
$LANG['ocsng'][33]="Нет заблокированных устройств"; 
$LANG['ocsng'][34]="Недоступные принтеры"; 
$LANG['ocsng'][35]="Никакой принтер не закрыт"; 
$LANG['ocsng'][36]="В организацию"; 
$LANG['ocsng'][37]="Включить предварительный просмотр"; 
$LANG['ocsng'][38]="Отключить предварительный просмотр"; 
...
$LANG['ocsng'][51]="Нет блокированных IP"; 
...
$LANG['plugins'][0]="Список плагинов"; 
...
$LANG['profiles'][33]="Пользователей не найдено"; 
...
$LANG['reservation'][27]="повторение"; 
...
$LANG['reservation'][35]="Будущее резервирование и в работе"; 
...
$LANG['reservation'][39]="Это удалит все резервирования в работе."; 
...
$LANG['rulesengine'][33]="Выпадающий список"; 
...
$LANG['rulesengine'][62]="Каталог: типы телефонов"; 
$LANG['rulesengine'][63]="Каталог: типы периферийных устройств"; 
$LANG['rulesengine'][64]="Каталог: типы принтеров"; 
$LANG['rulesengine'][65]="Каталог типов сетевых устройств"; 
$LANG['rulesengine'][66]="Типы"; 
$LANG['rulesengine'][67]="Словарь операционной системы"; 
$LANG['rulesengine'][68]="Каталог пакетов обновлений"; 
$LANG['rulesengine'][69]="Каталог: версии ОС"; 
...
$LANG['rulesengine'][83]="Вы можете повлиять на результат регулярного выражения с помощью строки #0"; 
...
$LANG['rulesengine'][95]="Выбор производителя"; 
$LANG['rulesengine'][96]="Повторно каталог для изготовителя(ей)<br> ( ----- = All)"; 
$LANG['rulesengine'][97]="Никакой элемент не надо проверять"; 
...
$LANG['rulesengine'][111]="Присвоение организаций"; 
...
$LANG['setup'][249]="группы запрашивающего"; 
...
$LANG['softwarecategories'][1]="Сворачивать"; 
$LANG['softwarecategories'][2]="Раскрывать"; 
...
$LANG['title'][10]="Выполнение заявки"; 
...
$LANG['tracking'][31]="Обрабатываемая (назначена)"; 
$LANG['tracking'][32]="Обрабатываемая (запланирована)"; 
