...
$LANG['cartridges'][6]="Добавить тип картриджа..."; 
...
$LANG['common'][40]="Вы хотите разглобализировать этот объект?"; 
...
$LANG['common'][82]="Мб"; 
$LANG['common'][83]="У вас нет разрешения на выполнение этого действия."; 
$LANG['common'][84]="Нельзя изменить  т.к. имеются связи."; 
$LANG['common'][85]="Изменить видимость для подчинённых орг-й"; 
$LANG['common'][86]="Не разрешено изменять видимость для подчиненных организаций"; 
...
$LANG['entity'][12]="DN организации"; 
$LANG['entity'][13]="TAG организации"; 
...
$LANG['help'][23]="Введите первые буквы (пользователь, объект или серийный номер)"; 
...
$LANG['log'][64]="изменение комментариев"; 
$LANG['log'][65]="правило"; 
...
$LANG['ocsconfig'][58]="Подключение автоматически соединяет сервер GLPI с сервером OCS. Эта опция работает при помощи скриптов синхронизации (не вручную)."; 
...
$LANG['profiles'][8]="Показать все решения(включая приватные)"; 
$LANG['profiles'][9]="Показывать общедоступные решения"; 
...
$LANG['reservation'][38]="Вы уверены, что хотите сделать это не резервируя?"; 
...
$LANG['ruleldap'][2]="Критерии не указаны"; 
...
$LANG['setup'][277]="Разглобализировать разрешенные лицензии"; 
...
$LANG['softwarecategories'][1]="Свернутые"; 
$LANG['softwarecategories'][2]="Развернутые"; 
...
$LANG['stats'][5]="Общее число заявок"; 
