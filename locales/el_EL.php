...
$LANG["tracking"][2]="Ή ολοκληρωμένη αναζήτηση"; 
$LANG["tracking"][3]="Λάθος ημερομηνίες. Η αναβάθμιση ακυρώθηκε."; 
$LANG["tracking"][8]="Καμία περιγραφή, παρακαλώ ξαναπροσπαθήστε"; 
...
$LANG["transfer"][2]="Προσθήκη παραμετροποιημένης μεταφοράς"; 
$LANG["transfer"][3]="Εάν δεν χρησιμοποιείται"; 
$LANG["transfer"][4]="Για άδειασμα της λίστας στοιχείων η οποία θα μεταφερθεί"; 
$LANG["transfer"][5]="Μπορείτε να συνεχίσετε την προσθήκη στοιχείων για μεταφορά"; 
$LANG["transfer"][6]="Σκεφτείτε να δημιουργήσετε αντίγραφο ασφαλείας πριν μεταφέρετε στοιχεία."; 
