...
$LANG["help"][20]="A descrição do seu problema não pôde ser adicionada ao banco de dados."; 
...
$LANG["ocsng"][43]="Acesso negado no banco de dados do OCS (Precisa ser habilitado para escrita no hardware.CHECKSUM)"; 
$LANG["ocsng"][44]="Acesso negado ao banco de dados do OCS (precisa ser habilitado para exclusão na tabela 'deleted_equiv')"; 
...
$LANG["update"][95]="A conexão com o banco de dados falhou, verifique os parâmetros da conexão incluídos no arquivo config_db.php"; 
