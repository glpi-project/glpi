...
function generate_entity($ID_entity){
	...
	for ($i=0;$i<$MAX['users_sadmin'];$i++){
		$query="INSERT INTO glpi_users VALUES (NULL,'sadmin$i-$ID_entity','',MD5('sadmin$i'),'sadmin$i@tutu.com','tel $i','tel2 $i','mobile $i','sadmin$i name','sadmin$i firstname','".mt_rand($FIRST['locations'],$LAST['locations'])."','no','fr_FR','comments $i')";
		$DB->query($query) or die("PB REQUETE ".$query);
	...
	for ($i=0;$i<$MAX['users_admin'];$i++){
		$query="INSERT INTO glpi_users VALUES (NULL,'admin$i-$ID_entity','',MD5('admin$i'),'admin$i@tutu.com','tel $i','tel2 $i','mobile $i','admin$i name','admin$i firstname','".mt_rand($FIRST['locations'],$LAST['locations'])."','no','fr_FR','comments $i')";
		$DB->query($query) or die("PB REQUETE ".$query);
		$user_id=$DB->insert_id();
	...
	for ($i=0;$i<$MAX['users_normal'];$i++){
		$query="INSERT INTO glpi_users VALUES (NULL,'normal$i-$ID_entity','',MD5('normal$i'),'normal$i@tutu.com','tel $i','tel2 $i','mobile $i','normal$i name','normal$i firstname','".mt_rand($FIRST['locations'],$LAST['locations'])."','no','fr_FR','comments $i')";
		$DB->query($query) or die("PB REQUETE ".$query);
		$user_id=$DB->insert_id();
	...
	for ($i=0;$i<$MAX['users_postonly'];$i++){
		$query="INSERT INTO glpi_users VALUES (NULL,'postonly$i-$ID_entity','',MD5('postonly$i'),'postonly$i@tutu.com','tel $i','tel2 $i','mobile $i','postonly$i name','postonly$i firstname','".mt_rand($FIRST['locations'],$LAST['locations'])."','no','fr_FR','comments $i')";
		$DB->query($query) or die("PB REQUETE ".$query);
		$user_id=$DB->insert_id();
	...
	for ($i=0;$i<max(1,pow($MAX['kbcategories'],1/3));$i++){
		$query="INSERT INTO glpi_dropdown_kbcategories VALUES (NULL,'$ID_entity','0','categorie $i','','comment categorie $i','1')";
		$DB->query($query) or die("PB REQUETE ".$query);
		$newID=$DB->insert_id();
		for ($j=0;$j<mt_rand(0,pow($MAX['kbcategories'],1/2));$j++){
			$query="INSERT INTO glpi_dropdown_kbcategories VALUES (NULL,'$ID_entity','$newID','s-categorie $j','','comment s-categorie $j','2')";
			$DB->query($query) or die("PB REQUETE ".$query);
			$newID2=$DB->insert_id();
			for ($k=0;$k<mt_rand(0,pow($MAX['kbcategories'],1/2));$k++){
				$query="INSERT INTO glpi_dropdown_kbcategories VALUES (NULL,'$ID_entity','$newID2','ss-categorie $k','','comment ss-categorie $k','3')";
				$DB->query($query) or die("PB REQUETE ".$query);
			}	
		}
	}	
	...
	$LAST["kbcategories"]=getMaxItem("glpi_dropdown_kbcategories");
