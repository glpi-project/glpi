...
$CFG_GLPI['languages'] =  //| NAME in native lang    |LANG FILE  |extjs| tinymce|english names|
      array('bg_BG' => array('Български',            'bg_BG.mo','bg',    'bg','bulgarian'),
            'ca_ES' => array('Català',               'ca_CA.mo','ca',    'ca','catalan'), // ca_ES
            'cs_CZ' => array('Čeština',              'cs_CZ.mo','cs',    'cs','czech'),
            'de_DE' => array('Deutsch',              'de_DE.mo','de',    'de','german'),
            'da_DK' => array('Dansk',                'dk_DK.mo','da',    'da','danish'), // da_DK
            'et_EE' => array('Eesti',                'ee_ET.mo','en',    'et','estonian'), // et_EE
            ...
            'el_GR' => array('Ελληνικά',             'el_EL.mo','el_GR', 'el','greek'), // el_GR
            'he_IL' => array('עברית',                'he_HE.mo','he',    'he','hebrew'), // he_IL
            ...
            'nb_NO' => array('Norsk (Bokmål)',       'no_NB.mo','no_NB', 'nb','norwegian'), // nb_NO
            'nn_NO' => array('Norsk (Nynorsk)',      'no_NN.mo','no_NN', 'nn','norwegian'), // nn_NO
            ...
            'uk_UA' => array('Українська',           'ua_UA.mo','ukr',   'en','ukrainian'), // uk_UA
