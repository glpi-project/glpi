...
$CFG_GLPI['languages'] =  //| NAME in native lang    |LANG FILE  |extjs| tinymce|english names|
      array('bg_BG' => array('Български',            'bg_BG.php','bg',    'bg','bulgarian'),
            ...
            'el_GR' => array('Ελληνικά',             'el_EL.php','el_GR', 'el','greek'), // el_GR
            'he_IL' => array('עברית',                'he_HE.php','he',    'he','hebrew'), // he_IL
            ...
            'nb_NO' => array('Norsk (Bokmål)',       'no_NB.php','no_NB', 'nb','norwegian'), // nb_NO
            'nn_NO' => array('Norsk (Nynorsk)',      'no_NN.php','no_NN', 'nn','norwegian'), // nn_NO
            ...
            'uk_UA' => array('Українська',           'ua_UA.php','ukr',   'en','ukrainian'), // uk_UA
