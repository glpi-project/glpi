...
$dp[DRIVE_DEVICE]=$lang["devices"][16];		
$dp[CONTROL_DEVICE]=$lang["devices"][16];		
$dp[GFX_DEVICE]=$lang["devices"][2];		
$dp[SND_DEVICE]=$lang["devices"][7];		
$dp[PCI_DEVICE]=$lang["devices"][16];		
$dp[CASE_DEVICE]=$lang["devices"][16];		
$dp[POWER_DEVICE]=$lang["devices"][16];
