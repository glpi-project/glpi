...
if (isset($_POST["validatortype"])) {
    switch ($_POST["validatortype"]) {
        case 'user':
            ...
            User::dropdown(['name'   => 'users_id_validate', // TODO
        ...
        case 'group':
            echo "<input type='hidden' name='users_id_validate' value=0 />"; // TODO
        ...
        case 'group_user':
            ...
            Dropdown::showFromArray("users_id_validate", $users, $param); // TODO
