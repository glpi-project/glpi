...
if (isset($items[$_POST["type"]])&&$_POST["type"]>0){
	...
	echo "      	new Ajax.Updater('results_ID$rand','".$cfg_install["root"]."/ajax/dropdownConnectPort.php',{asynchronous:true, evalScripts:true, ";
	echo "           onComplete:function(request)";
	echo "            {Element.hide('search_spinner$rand');}, ";
	echo "           onLoading:function(request)";
	echo "            {Element.show('search_spinner$rand');},";
	echo "           method:'post', parameters:'current=".$_POST['current']."&searchText=' + value+'&type=".$_POST["type"]."&myname=".$_POST['myname']."'";
	echo "})})";
	echo "</script>";	
