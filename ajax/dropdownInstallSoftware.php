...
// ----------------------------------------------------------------------
	...
	echo "      	new Ajax.Updater('results_ID$rand','".$cfg_install["root"]."/ajax/dropdownInstallLicense',{asynchronous:true, evalScripts:true, ";
	echo "           onComplete:function(request)";
	echo "            {Element.hide('search_spinner$rand');}, ";
	echo "           onLoading:function(request)";
	echo "            {Element.show('search_spinner$rand');},";
	echo "           method:'post', parameters:'searchText=' + value+'&sID=".$_POST["sID"]."&myname=".$_POST["myname"]."'";
	echo "})})";
	echo "</script>";	
