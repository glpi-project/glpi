...
class StatTest extends DbTestCase
{
     ...
     * @return array
     */
    public function constructEntryValuesProvider()
    {
        $params = [
            'technicien',
            'technicien_followup',
    ...
    private function assignExistingUserToTicket($tickets_id, $param, $users_id)
    {
        ...
        if ($param === 'technicien' || $param === 'technicien_followup') {
            $type = \CommonITILActor::ASSIGN;
        } else {
            $type = \CommonITILActor::REQUESTER;
        }
    ...
    public function testEdgeCases()
    {
        ...
        $this->assertNull($result, 'Should return null for invalid itemtype');
        ...
        $this->assertIsArray($result, 'Should return array even with empty dates');
        ...
        $this->assertIsArray($result, 'Should return array for future dates');
    }
}
