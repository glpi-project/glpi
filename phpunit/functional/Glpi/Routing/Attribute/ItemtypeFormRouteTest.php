...
class ItemtypeFormRouteTest extends GLPITestCase
{
    public static function itemtypeProvider(): iterable
    {
        yield [
            'itemtype'      => Computer::class,
            'expected_path' => '/front/computer.form.php',
        ];
        yield [
            'itemtype'      => Form::class,
            'expected_path' => '/front/form/form.form.php',
        ];
        yield [
            'itemtype'      => MyPsr4Dropdown::class,
            'expected_path' => '/front/mypsr4dropdown.form.php', // path must be relative to plugin path
        ];
        yield [
            'itemtype'      => Foo::class,
            'expected_path' => '/front/asset/foo.form.php', // path must be relative to plugin path
        ];
    }
