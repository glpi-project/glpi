...
class TicketTest extends DbTestCase
{
    ...
    public function testSearchOptions()
    {
        ...
        $this->assertFalse(array_key_exists('ITEM_Ticket_139', $ticket_with_so), "Erreur : La clé 'ITEM_Ticket_139' n'existe pas dans le tableau. Clés disponibles : " . implode(', ', array_keys($ticket_with_so)));
        ...
        $this->assertTrue(array_key_exists('ITEM_Ticket_141', $ticket_with_so));
        $this->assertEquals($last_task_date, $ticket_with_so['ITEM_Ticket_141']);
    }
