...
if (isset($_POST["add"]))
{
	...
	logEvent($_POST['sID'], "software", 4, "inventory", $_SESSION["glpiname"]." ".$LANG["log"][82]." ".$_POST["name"].".");
...
else if (isset($_POST["delete"]))
{
	...
	logEvent($version->fields['sID'], "software", 4, "inventory", $_SESSION["glpiname"]." ".$LANG["log"][84]." ".$_POST["name"]);
	glpi_header($CFG_GLPI["root_doc"]."/front/software.form.php?ID=".$version->fields['sID']);
}
else if (isset($_POST["update"]))
{
	...
	logEvent($version->fields['sID'], "software", 4, "inventory", $_SESSION["glpiname"]." ".$LANG["log"][83]." ".$_POST["name"]);
	glpi_header($CFG_GLPI["root_doc"]."/front/software.form.php?ID=".$version->fields['sID']);
} 
else
{
