<?php
/*
 * @version $Id: ldap.import.php 6217 2008-01-01 01:32:45Z moyo $
 -------------------------------------------------------------------------
...
elseif (!isset($_POST["import_ok"])){
	...
	else
	{
			...
			showLdapGroups($_SERVER['PHP_SELF'],$_GET['check'],$_GET['start'],0,$_SESSION["ldap_filter"],$_SESSION["glpiactive_entity"]);
	}
} else {
