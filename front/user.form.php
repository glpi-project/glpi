...
$NEEDED_ITEMS = array('computer', 'entity', 'group', 'ldap', 'monitor', 'networking', 'peripheral',
                      'phone', 'printer', 'profile', 'reservation', 'rulesengine', 'rule.right',
                      'setup', 'software', 'supplier', 'tracking', 'user');
