...
if ($show_problem) {
   echo "<td class='center b'><a href='stat.global.php?itemtype=Problem'>".$LANG['stats'][1]."</a>".
        "</td>";
}
echo "</tr>";
echo "<tr class='tab_bg_1'>";
...
echo "</td></tr>";
echo "<tr class='tab_bg_1'><td class='center'><a href='stat.location.php?itemtype=Ticket'>".
      "<span class='b'>".$LANG['stats'][3]."</span></a><br> ".
      "(".$LANG['common'][15].", ".$LANG['common'][17].", ".$LANG['computers'][9].", ".
        $LANG['devices'][4].", ".$LANG['computers'][36].", ".$LANG['devices'][2].", ".
        $LANG['devices'][5].")</td></tr>";
