...
//	asort($dp);
	...
	echo "<div align='center'><form method='post' action=\"".$cfg_glpi["root_doc"]."/front/setup.dropdowns.php\">";
	...
	switch ($which){
		...
		break;
		case "hdd_type" : 
		showFormDropDown($_SERVER["PHP_SELF"],"hdd_type",$lang["setup"][93],$ID,$value2);
		break;
		case "domain" : 
