...
if (isset($_POST["purge"])) {
   ...
   if ($item_device->isUsed()
       && empty($_POST["forcepurge"])) {
      Html::header($item_device->getTypeName(1), $_SERVER['PHP_SELF'], "config",
                   $item_device->second_level_menu, str_replace('glpi_','',$item_device->getTable()));
      $item_device->showDeleteConfirmForm($_SERVER['PHP_SELF']);
      Html::footer();
   } else {
