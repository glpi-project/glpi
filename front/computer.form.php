...
$NEEDED_ITEMS=array("computer","device","networking","monitor","printer","tracking","software","peripheral","reservation","infocom","contract","document","user","link","ocsng","phone","enterprise","search","registry","group","setup","ocsng");
