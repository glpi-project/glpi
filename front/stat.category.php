...
echo "<div align='center'><form method=\"post\" name=\"form\" action=\"stat.category.php\">";
...
//foreach these authors display
   for ($i=$_GET['start'];$i< $numrows && $i<($_GET['start']+$cfg_glpi["list_limit"]);$i++)
   {
	...
	echo "<td>".$nomUsr[$i]['category']."</td><td><a href='stat.graph.php?ID=".$nomUsr[$i]['ID']."&amp;type=category'><img src=\"".$HTMLRel."pics/stats_item.png\" alt='' title=''></a></td>";
