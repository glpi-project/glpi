...
if (isset($_POST["add"])) {
    ...
    $item_ticket = new Item_TicketRecurrent();
    $item_ticket->deleteByCriteria(['ticketrecurrents_id' => $_POST['ticketrecurrents_id'],
