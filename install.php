...
function step7()
{
	...
	echo "<tr><td>LDAP Host</td><td><input type=\"text\" name=\"ldap_host\" /></td></tr>";
	echo "<tr><td>Basedn</td><td><input type=\"text\" name=\"basedn\" /></td></tr>";
	echo "<tr><td>rootdn (for non anonymous binds)</td><td><input type=\"text\" name=\"rootdn\" /></td></tr>";
	echo "<tr><td>Pass (for non-anonymous binds)</td><td><input type=\"text\" name=\"pass\" /></td></tr>";
	echo "<tr><td>IMAP configuration</td><td></td></tr>";
	echo "<tr><td>IMAP Auth Server</td><td><input type=\"text\" name=\"imap_auth_server\" /></td></tr>";
	echo "<tr><td>IMAP Host Name (users email will be login@thishost)</td><td><input type=\"text\" name=\"imap_host\" /></td></tr>";
	echo "</table>";
