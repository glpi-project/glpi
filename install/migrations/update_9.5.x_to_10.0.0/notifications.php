...
if (!$notification_exists) {
    $DB->insertOrDie(
        ...
        '10.0 Add password initialization notification'
    );
    $notification_id = $DB->insertId();
    ...
    $DB->insertOrDie(
        ...
        '10.0 Add password initialization template'
    );
    ...
    HTML
        ...
        '10.0 Add password initialization notification template translations'
    );
    ...
    $DB->insertOrDie(
        ...
        '10.0 Add password initialization notification template'
    );
    ...
    $DB->insertOrDie(
        ...
        '10.0 Add password initialization target'
    );
}
/** /Password initialization notification */
