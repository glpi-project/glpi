...
if (!$DB->tableExists('glpi_databaseinstanceinstances')) {
   $query = "CREATE TABLE `glpi_databaseinstanceinstances` (
         `id` int NOT NULL AUTO_INCREMENT,
   ...
   $DB->queryOrDie($query, "10.0 add table glpi_databaseinstanceinstances");
}
