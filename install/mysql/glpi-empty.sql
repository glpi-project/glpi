...
CREATE TABLE `glpi_cables` (
  ...
  `entities_id` int NOT NULL DEFAULT '0',
  `is_recursive` tinyint NOT NULL DEFAULT '0',
  `itemtype_rear` varchar(255) DEFAULT NULL,
  `itemtype_front` varchar(255) DEFAULT NULL,
  `items_id_rear` int NOT NULL DEFAULT '0',
  `items_id_front` int NOT NULL DEFAULT '0',
  `socketmodels_id_rear` int NOT NULL DEFAULT '0',
  `front_socketmodels_id` int NOT NULL DEFAULT '0',
  `sockets_id_rear` int NOT NULL DEFAULT '0',
  `sockets_id_front` int NOT NULL DEFAULT '0',
  ...
  KEY `sockets_id_rear` (`sockets_id_rear`),
  KEY `sockets_id_front` (`sockets_id_front`),
