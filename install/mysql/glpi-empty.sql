...
CREATE TABLE `glpi_changes` (
  ...
  `date_creation` timestamp NULL DEFAULT NULL,
  `itilobject_templates_id` int unsigned NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`),
  KEY `name` (`name`),
  KEY `entities_id` (`entities_id`),
  KEY `is_recursive` (`is_recursive`),
  ...
  KEY `date_creation` (`date_creation`),
  KEY `itilobject_templates_id` (`itilobject_templates_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci ROW_FORMAT=DYNAMIC;
...
CREATE TABLE `glpi_tickettemplates` (
  ...
  `is_recursive` tinyint NOT NULL DEFAULT '0',
  `comment` text,
  `status_limit` varchar(255) NOT NULL DEFAULT '["1","2","3","4","5","6"]',
  PRIMARY KEY (`id`),
  KEY `name` (`name`),
  KEY `entities_id` (`entities_id`),
  KEY `is_recursive` (`is_recursive`)
...
CREATE TABLE `glpi_changetemplates` (
  ...
  `is_recursive` tinyint NOT NULL DEFAULT '0',
  `comment` text,
  `status_limit` varchar(255) NOT NULL DEFAULT '["1","9","10","7","4","11","12","5","8","6","14","13"]',
  PRIMARY KEY (`id`),
  KEY `name` (`name`),
  KEY `entities_id` (`entities_id`),
  KEY `is_recursive` (`is_recursive`)
...
CREATE TABLE `glpi_problemtemplates` (
  ...
  `is_recursive` tinyint NOT NULL DEFAULT '0',
  `comment` text,
  `status_limit` varchar(255) NOT NULL DEFAULT '["1","7","2","3","4","5","8","6"]',
  PRIMARY KEY (`id`),
  KEY `name` (`name`),
  KEY `entities_id` (`entities_id`),
  KEY `is_recursive` (`is_recursive`)
