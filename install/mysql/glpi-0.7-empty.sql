#GLPI Dump database on 2006-11-05 15:02
...
CREATE TABLE `glpi_dropdown_kbcategories` (
  ...
  PRIMARY KEY  (`ID`),
  UNIQUE KEY `name` (`name`,`parentID`,`ID_entity`),
...
### Dump table glpi_entity

DROP TABLE IF EXISTS `glpi_entity`;
...
INSERT INTO glpi_event_log VALUES ('1','-1','system','2006-11-05 15:02:03','login','3','glpi connexion de l\'IP : 127.0.0.1');
