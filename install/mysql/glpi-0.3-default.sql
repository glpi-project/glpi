...
INSERT INTO `followups` (`ID`, `tracking`, `date`, `author`, `contents`) VALUES (1, 1, '2003-09-18 00:53:35', 'tech', 'J\\\'ai �t� voir, je pense que la carte mere a grill�.');
...
INSERT INTO `followups` (`ID`, `tracking`, `date`, `author`, `contents`) VALUES (3, 1, '2003-09-18 00:54:40', 'tech', 'Probleme regl� j\\\'ai seulement chang� l\\\'alimentation.\r\nLe reste fonctionne tres bien.');
...
INSERT INTO `followups` (`ID`, `tracking`, `date`, `author`, `contents`) VALUES (5, 2, '2003-09-18 00:55:52', 'tech', 'Je suis pass�, il faudra faire une restauration de windows NT4.');
...
INSERT INTO `tracking` (`ID`, `date`, `closedate`, `status`, `author`, `assign`, `computer`, `contents`, `priority`, `is_group`, `uemail`, `emailupdates`) VALUES (2, '2003-09-18 00:48:19', '0000-00-00 00:00:00', 'new', 'Helpdesk', 'tech', 10, 'Un message en anglais s\\\'affiche, je n\\\'y comprend rien, je n\\\'ose plus toucher � rien de peur de tout casser.\r\nVenez vite !!!!', 4, 'no', '', '');
