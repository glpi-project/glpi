...
$tables['glpi_notifications'] = [
   'COLUMNS'   => ['id', 'name', 'itemtype', 'event', 'is_recursive', 'is_active'],
   'VALUES'    => [
      [1, 'Alert Tickets not closed', 'Ticket', 'alertnotclosed', 1, 1],
      [2, 'New Ticket', 'Ticket', 'new', 1, 1],
      [3, 'Update Ticket', 'Ticket', 'update', 1, 0],
      [4, 'Close Ticket', 'Ticket', 'closed', 1, 1],
      [5, 'Add Followup', 'Ticket', 'add_followup', 1, 1],
      [6, 'Add Task', 'Ticket', 'add_task', 1, 1],
      [7, 'Update Followup', 'Ticket', 'update_followup', 1, 1],
      [8, 'Update Task', 'Ticket', 'update_task', 1, 1],
      [9, 'Delete Followup', 'Ticket', 'delete_followup', 1, 1],
      [10, 'Delete Task', 'Ticket', 'delete_task', 1, 1],
      [11, 'Resolve ticket', 'Ticket', 'solved', 1, 1],
      [12, 'Ticket Validation', 'Ticket', 'validation', 1, 1],
      [13, 'New Reservation', 'Reservation', 'new', 1, 1],
      [14, 'Update Reservation', 'Reservation', 'update', 1, 1],
      [15, 'Delete Reservation', 'Reservation', 'delete', 1, 1],
      [16, 'Alert Reservation', 'Reservation', 'alert', 1, 1],
      [17, 'Contract Notice', 'Contract', 'notice', 1, 1],
      [18, 'Contract End', 'Contract', 'end', 1, 1],
      [19, 'MySQL Synchronization', 'DBConnection', 'desynchronization', 1, 1],
      [20, 'Cartridges', 'CartridgeItem', 'alert', 1, 1],
      [21, 'Consumables', 'ConsumableItem', 'alert', 1, 1],
      [22, 'Infocoms', 'Infocom', 'alert', 1, 1],
      [23, 'Software Licenses', 'SoftwareLicense', 'alert', 1, 1],
      [24, 'Ticket Recall', 'Ticket', 'recall', 1, 1],
      [25, 'Password Forget', 'User', 'passwordforget', 1, 1],
      [26, 'Ticket Satisfaction', 'Ticket', 'satisfaction', 1, 1],
      [27, 'Item not unique', 'FieldUnicity', 'refuse', 1, 1],
      [28, 'Crontask Watcher', 'CronTask', 'alert', 1, 1],
      [29, 'New Problem', 'Problem', 'new', 1, 1],
      [30, 'Update Problem', 'Problem', 'update', 1, 1],
      [31, 'Resolve Problem', 'Problem', 'solved', 1, 1],
      [32, 'Add Task', 'Problem', 'add_task', 1, 1],
      [33, 'Update Task', 'Problem', 'update_task', 1, 1],
      [34, 'Delete Task', 'Problem', 'delete_task', 1, 1],
      [35, 'Close Problem', 'Problem', 'closed', 1, 1],
      [36, 'Delete Problem', 'Problem', 'delete', 1, 1],
      [37, 'Ticket Validation Answer', 'Ticket', 'validation_answer', 1, 1],
      [38, 'Contract End Periodicity', 'Contract', 'periodicity', 1, 1],
      [39, 'Contract Notice Periodicity', 'Contract', 'periodicitynotice', 1, 1],
      [40, 'Planning recall', 'PlanningRecall', 'planningrecall', 1, 1],
      [41, 'Delete Ticket', 'Ticket', 'delete', 1, 1],
      [42, 'New Change', 'Change', 'new', 1, 1],
      [43, 'Update Change', 'Change', 'update', 1, 1],
      [44, 'Resolve Change', 'Change', 'solved', 1, 1],
      [45, 'Add Task', 'Change', 'add_task', 1, 1],
      [46, 'Update Task', 'Change', 'update_task', 1, 1],
      [47, 'Delete Task', 'Change', 'delete_task', 1, 1],
      [48, 'Close Change', 'Change', 'closed', 1, 1],
      [49, 'Delete Change', 'Change', 'delete', 1, 1],
      [50, 'Ticket Satisfaction Answer', 'Ticket', 'replysatisfaction', 1, 1],
      [51, 'Receiver errors', 'MailCollector', 'error', 1, 1],
      [52, 'New Project', 'Project', 'new', 1, 1],
      [53, 'Update Project', 'Project', 'update', 1, 1],
      [54, 'Delete Project', 'Project', 'delete', 1, 1],
      [55, 'New Project Task', 'ProjectTask', 'new', 1, 1],
      [56, 'Update Project Task', 'ProjectTask', 'update', 1, 1],
      [57, 'Delete Project Task', 'ProjectTask', 'delete', 1, 1],
      [58, 'Request Unlock Items', 'ObjectLock', 'unlock', 1, 1],
      [59, 'New user in requesters', 'Ticket', 'requester_user', 1, 1],
      [60, 'New group in requesters', 'Ticket', 'requester_group', 1, 1],
      [61, 'New user in observers', 'Ticket', 'observer_user', 1, 1],
      [62, 'New group in observers', 'Ticket', 'observer_group', 1, 1],
      [63, 'New user in assignees', 'Ticket', 'assign_user', 1, 1],
      [64, 'New group in assignees', 'Ticket', 'assign_group', 1, 1],
      [65, 'New supplier in assignees', 'Ticket', 'assign_supplier', 1, 1],
      [66, 'Saved searches', 'SavedSearch_Alert', 'alert', 1, 1],
      [67, 'Certificates', 'Certificate', 'alert', 1, 1],
   ]
];

$tables['glpi_notifications_notificationtemplates'] = [
   'COLUMNS'   => ['id', 'notifications_id', 'mode', 'notificationtemplates_id'],
   'VALUES'    => [
      [1, '1', 'mailing', 6],
      [2, '2', 'mailing', 4],
      [3, '3', 'mailing', 4],
...
$tables['glpi_notificationtargets'] = [
   'COLUMNS'   => ['id', 'items_id', 'type', 'notifications_id'],
   'VALUES'    => [
      ['1', '3', '1', '13'],
      ['2', '1', '1', '13'],
      ['3', '3', '2', '2'],
...
$tables['glpi_notificationtemplates'] = [
   'COLUMNS'   => ['id', 'name', 'itemtype'],
   'VALUES'    => [
      ['1', 'MySQL Synchronization', 'DBConnection'],
      ['2', 'Reservations', 'Reservation'],
      ['3', 'Alert Reservation', 'Reservation'],
      ['4', 'Tickets', 'Ticket'],
      ['5', 'Tickets (Simple)', 'Ticket'],
      ['6', 'Alert Tickets not closed', 'Ticket'],
      ['7', 'Tickets Validation', 'Ticket'],
      ['8', 'Cartridges', 'CartridgeItem'],
      ['9', 'Consumables', 'ConsumableItem'],
      ['10', 'Infocoms', 'Infocom'],
      ['11', 'Licenses', 'SoftwareLicense'],
      ['12', 'Contracts', 'Contract'],
      ['13', 'Password Forget', 'User'],
      ['14', 'Ticket Satisfaction', 'Ticket'],
      ['15', 'Item not unique', 'FieldUnicity'],
      ['16', 'CronTask', 'CronTask'],
      ['17', 'Problems', 'Problem'],
      ['18', 'Planning recall', 'PlanningRecall'],
      ['19', 'Changes', 'Change'],
      ['20', 'Receiver errors', 'MailCollector'],
      ['21', 'Projects', 'Project'],
      ['22', 'Project Tasks', 'ProjectTask'],
      ['23', 'Unlock Item request', 'ObjectLock'],
      ['24', 'Saved searches alerts', 'SavedSearch_Alert'],
...
$tables['glpi_requesttypes'] = [
   'COLUMNS'   => ['id', 'name', 'is_helpdesk_default', 'is_followup_default', 'is_mail_default', 'is_mailfollowup_default'],
   'VALUES'    => [
      ['1', 'Helpdesk', '1', '1', '0', '0'],
      ['2', 'E-Mail', '0', '0', '1', '1'],
      ['3', 'Phone', '0', '0', '0', '0'],
