...
CREATE TABLE users (
  ...
  can_assign_job enum('0','1') NOT NULL default '0',
  PRIMARY KEY  (name),
  KEY type (type)
) TYPE=MyISAM;
...
INSERT INTO users VALUES ('Helpdesk', '14e43c2d31dcbdd1', NULL, 'Admin', NULL, 'post-only', 'Helpdesk Injector', '0');
INSERT INTO users VALUES ('glpi', '5b9b1ee2216a5ffe', '', '2nd etage', '', 'admin', 'glpi', '1');
INSERT INTO users VALUES ('post-only', '3eb831c67be6aeda', NULL, '1 ier etage', NULL, 'post-only', 'post-only', '0');
INSERT INTO users VALUES ('tech', '37bd7c4221e8a247', NULL, '2nd etage', NULL, 'admin', 'technicien', '0');
INSERT INTO users VALUES ('normal', '109e7883561b4202', NULL, '1 ier etage', NULL, 'normal', 'utilisateur normal', '0');
