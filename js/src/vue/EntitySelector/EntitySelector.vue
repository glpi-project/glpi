...
<template>
    <div>
        <a href="#" class="dropdown-item dropdown-toggle entity-dropdown-toggle" data-bs-toggle="dropdown"
           data-bs-auto-close="outside" :title="current_entity_label" :aria-label="__('Select the desired entity')">
        ...
        <div class="dropdown-menu p-3">
            ...
            <div class="input-group">
                ...
                <button class="btn btn-secondary" :title="select_all_message" data-bs-toggle="tooltip" data-bs-placement="top"
                        :form="`switch_to_full_structure_${rand}`" type="submit">
                    <i class="ti ti-eye"></i>
                </button>
            </div>
