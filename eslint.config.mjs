...
export default [
    ...
    {
        // Modules
        files: ["js/modules/**", "eslint.config.mjs", "vite.config-vue.js", "vite.config-legacy.js"],
        languageOptions: {
            sourceType: "module"
        }
    },
    ...
    },
    {
        // Config files
        "files": [
            "eslint.config.mjs", ".stylelintrc.js", ".webpack.config.js", ".vue.webpack.config.js", "tests/cypress.config.js",
            "vite.config-vue.js", "vite.config-legacy.js"
        ],
        "languageOptions": {
            "globals": {...globals.node}
        },
