...
$worksheet->write(0, 0, html_entity_decode($lang["monitors"][27]), $border1);
$worksheet->write(0, 1, html_entity_decode($lang["monitors"][5]), $border1);
$worksheet->write(0, 2, html_entity_decode($lang["monitors"][16]),   $border1);
$worksheet->write(0, 3, html_entity_decode($lang["monitors"][8]), $border1);
$worksheet->write(0, 4, html_entity_decode($lang["monitors"][7]), $border1);
$worksheet->write(0, 5, html_entity_decode($lang["monitors"][12]), $border1);
$worksheet->write(0, 6, html_entity_decode($lang["monitors"][10]), $border1);
$worksheet->write(0, 7, html_entity_decode($lang["monitors"][11]), $border1);
$worksheet->write(0, 8, html_entity_decode($lang["monitors"][21]), $border1);
$worksheet->write(0, 9, html_entity_decode($lang["monitors"][14]), $border1);
$worksheet->write(0, 10, html_entity_decode($lang["monitors"][15]), $border1);
$worksheet->write(0, 11, html_entity_decode($lang["monitors"][19]), $border1);
$worksheet->write(0, 12, html_entity_decode($lang["monitors"][20]), $border1);
$worksheet->write(0, 13, html_entity_decode($lang["monitors"][24]), $border1);
$worksheet->write(0, 14, html_entity_decode($lang["monitors"][25]), $border1);
$worksheet->write(0, 15, html_entity_decode($lang["monitors"][26]), $border1);
$worksheet->write(0, 16, html_entity_decode($lang["monitors"][13]),  $border1);
$worksheet->write(0, 17, html_entity_decode($lang["monitors"][9]),  $border1);
