 ...
 * @since version 9.3
**/
class ChangeTemplatePredefinedField extends CommonDBChild {
   ...
   **/
   function getRawName() {
      ...
      $fields = $ct->getAllowedFieldsNames(true, true);
   ...
   **/
   function getPredefinedFields($ID, $withtypeandcategory = false) {
      ...
      $ct             = new ChangeTemplate();
      $allowed_fields = $ct->getAllowedFields($withtypeandcategory, true);
      $fields         = [];
   ...
   **/
   static function getMultiplePredefinedValues() {
      ...
      $change = new Change();
      $fields = [$change->getSearchOptionIDByField('field', 'name', 'glpi_documents'),
                      $change->getSearchOptionIDByField('field', 'items_id', 'glpi_changes_items'),
                      $change->getSearchOptionIDByField('field', 'name', 'glpi_tasktemplates'),
                     ];
   ...
   **/
   static function showForChangeTemplate(ChangeTemplate $ct, $withtemplate = 0) {
      ...
      $query = "SELECT `glpi_changetemplatepredefinedfields`.*
                FROM `glpi_changetemplatepredefinedfields`
      ...
      if ($result = $DB->query($query)) {
         ...
         if ($numrows) {
            ...
            foreach ($predeffields as $data) {
               ...
               echo $change->getValueToDisplay($searchOption[$data['num']], $display_datas,
                                               $display_options);
               echo "</td>";
               echo "</tr>";
            }
