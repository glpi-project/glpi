	...
	if ($CFG_GLPI["debug"]==2){ // mode debug 
		...
		if ($CFG_GLPI["debug_sql"]){	
			...
			foreach ($DEBUG_SQL['queries'] as $num => $query){
				...
				echo eregi_replace(">","&gt;",eregi_replace("<","&lt;",eregi_replace("ORDER BY","<br>ORDER BY",eregi_replace("SORT","<br>SORT",eregi_replace("LEFT JOIN","<br>LEFT JOIN",eregi_replace("WHERE","<br>WHERE",eregi_replace("FROM","<br>FROM",eregi_replace("UNION","<br>UNION<br>",$query))))))));
				echo "</td><td>";
