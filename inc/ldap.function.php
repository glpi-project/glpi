   ...
   if (is_array($ldap_groups)) {
      ...
      if ($numrows > 0) {
         ...
         foreach ($ldap_groups as $groupinfos) {
            ...
            echo "<td>" .$group_dn. "</td>";
            echo "<td>";
            CommonDropdown::dropdownValue("glpi_entities", "toimport_entities[" .$group_dn . "]=".$entity, $entity);
            echo "</td>";
...
function formChangeAuthMethodToLDAP($ID) {
   ...
   if ($DB->numrows($result) > 0) {
      ...
      CommonDropdown::dropdownValue("glpi_authldaps","auths_id");
      echo "</td>";
      echo "<tr class='tab_bg_2'><td colspan='2'class='center'>";
...
function formChangeAuthMethodToMail($ID) {
   ...
   if ($DB->numrows($result) > 0) {
      ...
      CommonDropdown::dropdownValue("glpi_authmails","auths_id");
      echo "</td>";
      echo "<tr class='tab_bg_2'><td colspan='2'class='center'>";
