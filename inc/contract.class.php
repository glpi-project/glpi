...
class Contract extends CommonDBTM {
   ...
   **/
   ...
   static function showCentral() {
      ...
      echo "<td class='numerique'>".$contract0."</td></tr>";
      echo "<tr class='tab_bg_2'>";
      echo "<td><a href=\"".$CFG_GLPI["root_doc"]."/front/contract.php?reset=reset&amp;".
      ...
      echo "<td class='numerique'>".$contract7."</td></tr>";
      echo "<tr class='tab_bg_2'>";
      echo "<td><a href=\"".$CFG_GLPI["root_doc"]."/front/contract.php?reset=reset&amp;".
      ...
      echo "<td class='numerique'>".$contract30."</td></tr>";
      echo "<tr class='tab_bg_2'>";
      echo "<td><a href=\"".$CFG_GLPI["root_doc"]."/front/contract.php?reset=reset&amp;".
      ...
      echo "<td class='numerique'>".$contractpre7."</td></tr>";
      echo "<tr class='tab_bg_2'>";
      echo "<td><a href=\"".$CFG_GLPI["root_doc"]."/front/contract.php?reset=reset&amp;".
      ...
      echo "<td class='numerique'>".$contractpre30."</td></tr>";
      echo "</table>";
   }
