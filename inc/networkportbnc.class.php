...
/// NetworkPortBnc class : BNC instantiation of NetworkPort
class NetworkPortBnc extends NetworkPortInstantiation {
   ...
   function showInstantiationForm(NetworkPort $netport, $options, $recursiveItems) {
      ...
      Dropdown::show('NetworkPortBncType', ['name'    => 'networkportbnctypes_id',
                                            'value'   => $this->fields['networkportbnctypes_id']]);
      echo "</td>";
   ...
   function getInstantiationHTMLTableHeaders(HTMLTableGroup $group, HTMLTableSuperHeader $super,
      ...
      DeviceNetworkCard::getHTMLTableHeader('NetworkPortBnc', $group, $super, $header,
                                            $options);
   ...
   protected function getPeerInstantiationHTMLTable(NetworkPort $netport, HTMLTableRow $row,
      ...
      if (!empty($this->fields['type'])) {
         $row->addCell($row->getHeaderByName('Instantiation', 'type'),
                        Dropdown::getDropdownName(NetworkPortBncType::getTable(), $this->fields["networkportbnctypes_id"]),
                       $father);
      }
   ...
   function rawSearchOptions() {
      ...
      $tab[] = [
         'id'                 => '11',
         'table'              => 'glpi_networkportbnctypes',
         'field'              => 'name',
         'name'               => __('BNC port type'),
         'datatype'           => 'dropdown'
      ];
   ...
   **/
   ...
   /**
    * Get the possible value for BNC port speed
    *
