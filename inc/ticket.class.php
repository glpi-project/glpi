            ...
            switch ($input['_ticket_requester']['_type']) {
               case "user" :
                  ...
                  if ((isset($input['_ticket_requester']['alternative_email'])
                     ...
                     if (isset($input['_auto_update']) || $ticket_user->can(-1,'w',$input['_ticket_requester'])) {
            ...
            switch ($input['_ticket_observer']['_type']) {
               case "user" :
                  ...
                  if ((isset($input['_ticket_observer']['alternative_email'])
                     ...
                     $ticket_user = new Ticket_User();
                     if (isset($input['_auto_update']) || $ticket_user->can(-1,'w',$input['_ticket_observer'])) {
...
//                        && empty($this->fields['solution']);
   ...
   **/
   static function showActorAddForm($type, $rand_type, $entities_id, $inticket=true,
                                    $withemail=false, $withsupplier = false) {
      global $LANG, $CFG_GLPI;
   ...
   function showActorsPartForm($ID, $options) {
      ...
      if ($ID && haveRight("update_ticket","1")) {
         ...
         echo "&nbsp;&nbsp;<a href='".$CFG_GLPI["root_doc"].
              ...
              $LANG['buttons'][8]."&nbsp;".$_SESSION['glpiname']."</a>";
      }
