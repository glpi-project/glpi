...
class RuleChangeCollection extends RuleCollection {
   ...
   **/
   ...
   static function canView() {
      return Session::haveRightsOr(self::$rightname, [READ, RuleChange::PARENT]);
   }
   ...
   **/
   function showInheritedTab() {
      return (Session::haveRight(self::$rightname, RuleChange::PARENT) && ($this->entity));
   }
