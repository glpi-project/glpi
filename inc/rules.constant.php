...
$RULES_CRITERIAS[RULE_TRACKING_AUTO_ACTION]['category']['table']='glpi_ticketscategories';
...
$RULES_ACTIONS[RULE_SOFTWARE_CATEGORY]['category']['table']='glpi_softwarescategories';
