...
$RULES_CRITERIAS[RULE_LDAP_AFFECT_ENTITY]['LDAP_NAME']['table']='glpi_auth_ldap';
$RULES_CRITERIAS[RULE_LDAP_AFFECT_ENTITY]['LDAP_NAME']['field']='name';
$RULES_CRITERIAS[RULE_LDAP_AFFECT_ENTITY]['LDAP_NAME']['name']=$LANG["login"][2];
$RULES_CRITERIAS[RULE_LDAP_AFFECT_ENTITY]['LDAP_NAME']['linkfield']='';
$RULES_CRITERIAS[RULE_LDAP_AFFECT_ENTITY]['LDAP_NAME']['type']='dropdown';
