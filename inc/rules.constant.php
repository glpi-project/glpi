...
$RULES_CRITERIAS[RULE_TRACKING_AUTO_ACTION][1]['ID']='name';
$RULES_CRITERIAS[RULE_TRACKING_AUTO_ACTION][1]['table']='glpi_tracking';
$RULES_CRITERIAS[RULE_TRACKING_AUTO_ACTION][1]['field']='name';
$RULES_CRITERIAS[RULE_TRACKING_AUTO_ACTION][1]['name']=$LANG["common"][57];
$RULES_CRITERIAS[RULE_TRACKING_AUTO_ACTION][1]['linkfield']='name';

$RULES_CRITERIAS[RULE_TRACKING_AUTO_ACTION][2]['ID']='category';
$RULES_CRITERIAS[RULE_TRACKING_AUTO_ACTION][2]['table']='glpi_dropdown_tracking_category';
$RULES_CRITERIAS[RULE_TRACKING_AUTO_ACTION][2]['field']='name';
$RULES_CRITERIAS[RULE_TRACKING_AUTO_ACTION][2]['name']=$LANG["common"][36];
$RULES_CRITERIAS[RULE_TRACKING_AUTO_ACTION][2]['linkfield']='category';
