...
$RULES_CRITERIAS[RULE_LDAP_AFFECT_ENTITY]['MAIL_SERVER']['table']='glpi_auth_mail';
$RULES_CRITERIAS[RULE_LDAP_AFFECT_ENTITY]['MAIL_SERVER']['field']='name';
$RULES_CRITERIAS[RULE_LDAP_AFFECT_ENTITY]['MAIL_SERVER']['name']=$LANG["login"][3];
$RULES_CRITERIAS[RULE_LDAP_AFFECT_ENTITY]['MAIL_SERVER']['linkfield']='';
$RULES_CRITERIAS[RULE_LDAP_AFFECT_ENTITY]['MAIL_SERVER']['type']='dropdown';
$RULES_CRITERIAS[RULE_LDAP_AFFECT_ENTITY]['MAIL_SERVER']['virtual']='true';
$RULES_CRITERIAS[RULE_LDAP_AFFECT_ENTITY]['MAIL_SERVER']['id']='mail_server';

$RULES_CRITERIAS[RULE_LDAP_AFFECT_ENTITY]['MAIL_EMAIL']['table']='';
$RULES_CRITERIAS[RULE_LDAP_AFFECT_ENTITY]['MAIL_EMAIL']['field']='';
$RULES_CRITERIAS[RULE_LDAP_AFFECT_ENTITY]['MAIL_EMAIL']['name']=$LANG["login"][6]." ".$LANG["login"][3];
$RULES_CRITERIAS[RULE_LDAP_AFFECT_ENTITY]['MAIL_EMAIL']['linkfield']='';
$RULES_CRITERIAS[RULE_LDAP_AFFECT_ENTITY]['MAIL_EMAIL']['virtual']='true';
$RULES_CRITERIAS[RULE_LDAP_AFFECT_ENTITY]['MAIL_EMAIL']['id']='mail_email';
