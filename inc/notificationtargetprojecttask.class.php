...
class NotificationTargetProjectTask extends NotificationTarget {
   ...
   **/
   function getDatasForTemplate($event, $options=array()) {
      ...
      $this->datas['##projecttask.url##']      = $this->formatURL($options['additionnaloption']['usertype'],
                                              "ProjectTask_".$item->getField("id"));
      $this->datas["##projecttask.name##"]           = $item->getField('name');
      $this->datas["##projecttask.project##"]        = Dropdown::getDropdownName('glpi_projects',
                                                          $item->getField('projects_id'));
      $this->datas["##projecttask.projecturl##"]     = $this->formatURL($options['additionnaloption']['usertype'],
      ...
      $this->datas["##projecttask.plannedduration##"]   = Html::timestampToString($item->getField('planned_duration'),
                                                   false);
      $this->datas["##projecttask.effectiveduration##"] = Html::timestampToString($item->getField('effective_duration'),
                                                   false);
      ...
      $this->datas["##projecttask.totalduration##"] = Html::timestampToString(
   ...
   function getTags() {
      ...
      $tags_all = array('projecttask.url'               => __('URL'),
                        ...
                        'projecttask.numberoflogs'   => sprintf(__('%1$s: %2$s'), __('Historical'),
                                                                  _x('quantity', 'Number of items')),
                        'projecttask.log.date'       => sprintf(__('%1$s: %2$s'), __('Historical'),
                                                                  __('Date')),
                        'projecttask.log.user'       => sprintf(__('%1$s: %2$s'), __('Historical'),
                                                                  __('User')),
                        'projecttask.log.field'      => sprintf(__('%1$s: %2$s'), __('Historical'),
                                                                  __('Field')),
                        'projecttask.log.content'    => sprintf(__('%1$s: %2$s'), __('Historical'),
                                                                  _x('name', 'Update')),
      ...
      $tags = array('ticket.id'               => sprintf(__('%1$s: %2$s'), __('Ticket'), __('ID')),
                    ...
                    'ticket.content'          => sprintf(__('%1$s: %2$s'), __('Ticket'),
                                                         __('Description')),
                    'projecttask.projecturl'  => sprintf(__('%1$s: %2$s'), __('Project'),
                                                            __('URL')),
