            ...
            if (isset($options['order'])) {
               switch ($options['order']) {
                  ...
                  case 'ip' :
                     ...
                     $criteria['ORDERBY'] = new QueryExpression(
                        "ISNULL (".$DB->quoteName('glpi_ipaddresses.id')."),
                           ".$DB->quoteName('glpi_ipaddresses.binary_3').", ".$DB->quoteName('glpi_ipaddresses.binary_2').",
                           ".$DB->quoteName('glpi_ipaddresses.binary_1').", ".$DB->quoteName('glpi_ipaddresses.binary_0')
                     );
                     break;
                  ...
                  case 'alias' :
                     ...
                     $criteria['ORDERBY'] = new QueryExpression(
                        "ISNULL (".$DB->quoteName('glpi_networkaliases.name')."),
                           ".$DB->quoteName('glpi_networkaliases.name')
                     );
                     break;
               }
            }
