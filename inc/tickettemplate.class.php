      ...
      if (!isset($allowed_fields[$withtypeandcategory][$withitemtype])) {
         ...
         $allowed_fields[$withtypeandcategory][$withitemtype]
             = array($ticket->getSearchOptionIDByField('field', 'name',
                     ...
                     $ticket->getSearchOptionIDByField('field', 'slt_takeintoaccount',  
                                                       'glpi_slts')      => 'slt_takeintoaccount',
                     $ticket->getSearchOptionIDByField('field', 'slt_resolution',
                                                       'glpi_slts')      => 'slt_resolution',
