...
class Device extends CommonDBTM {
   ...
   **/
   ...
   function showForm ($target,$ID) {
      ...
      $this->showTabs($ID, "",array("devicetype"=>$this->devtype,"referer"=>$REFERER));
      ...
      switch($this->table) {
         ...
         case "glpi_devicememories" :
            ...
            echo "<td>";
            Dropdown::show('DeviceMemoryType', array('value' => $this->fields["devicememorytypes_id"]));
            echo "</td></tr>";
            echo "<tr class='tab_bg_1'>";
            echo "<td>".$LANG['device_ram'][1]."&nbsp;:</td><td>";
            autocompletionTextField("frequence",$this->table,"frequence",
         ...
         case "glpi_deviceharddrives" :
            ...
            echo "<td>";
            Dropdown::show('InterfaceType', array('value' => $this->fields["interfacetypes_id"]));
            echo "</td></tr>";
            break;
         ...
         case "glpi_devicecases" :
            ...
            echo "<td>";
            Dropdown::show('DeviceCaseType', array('value' => $this->fields["devicecasetypes_id"]));
