   ...
   function getTemplateByLanguage(NotificationTarget $target, $user_infos = array(), $event, $options = array()) {
      ...
      if (!isset($this->templates_by_languages[$tid])) {
         ...
         if ($template_datas = $this->getByLanguage($language)) {
            ...
            $content_text .= Html::clean(self::process($template_datas['content_text'], $data));
            
            $content_text .= "\n\n";
            $content_text .= "--";
            $content_text .= "\n";
            
            $content_text .= $this->signature;
            
            $content_text .= "\n";
            
            $content_text .= Html::entity_decode_deep($glpi_signature);
            $content_text .= "\n\n";
            ...
            if (!empty($template_datas['content_html'])) {
               ...
               $content_html .= '<title>' . Html::entities_deep($lang['subject']) . '</title>' . "\n";
               ...
               $content_html .= $template_datas['content_html'];
