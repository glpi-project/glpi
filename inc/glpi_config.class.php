 ...
 *  GLPI configuration
**/
class GlpiConfig extends ArrayObject {

   /**
    * Instanciate main configuration
    */
   public function __construct() {
      ...
      $CFG_GLPI['itemdevices'] = [
         ...
         'Item_DeviceControl',
         'Item_DeviceHardDrive', 'Item_DeviceDrive',
         'Item_DeviceMemory',
      ...
      $CFG_GLPI['helpdesk_visible_types'] = [
         'Software'
      ];
      ...
      $CFG_GLPI['itemdevices_itemaffinity'] = [
         'Computer'
      ];

      $CFG_GLPI['itemdevicememory_types'] = [
         'Computer',
         'NetworkEquipment',
         'Peripheral',
         'Printer'
      ...
      $CFG_GLPI['itemdevicepowersupply_types'] = [
         'Computer',
         'NetworkEquipment',
         'Enclosure'
      ];

      $CFG_GLPI['itemdevicenetworkcard_types'] = [
         'Computer',
         'NetworkEquipment',
         'Peripheral',
         'Phone',
      ...
      $CFG_GLPI['itemdeviceharddrive_types'] = [
         'Computer',
         'Peripheral',
         'NetworkEquipment',
         'Printer'
      ...
      $CFG_GLPI['itemdevicebattery_types'] = [
         'Computer',
         'Peripheral',
         'Phone',
         'Printer'
      ...
      $CFG_GLPI['itemdevicesimcard_types'] = [
         'Computer',
         'Peripheral',
         'Phone',
         'NetworkEquipment',
      ...
      $CFG_GLPI['itemdevicesensor_types'] = [
         'Computer',
         'Peripheral'
      ];
      ...
      // Items which can plan something
      ...
      $CFG_GLPI['user_pref_field'] = [
         ...
         'layout',
         'ticket_timeline',
         'ticket_timeline_keep_replaced_tabs',
         'palette',
         'highcontrast_css'
      ];
      ...
      /** FIXME: CFG_GlPI should not be used as cache... */
      // Init to store glpi itemtype / tables link
      $CFG_GLPI['glpitables'] = [];
      $CFG_GLPI['glpitablesitemtype'] = [];
      $CFG_GLPI['glpiitemtypetables'] = [];

      parent::__construct($CFG_GLPI);
   }

   public function offsetGet($index) {
      if ($index == 'ticket_types') {
         Toolbox::deprecated('Use itil_types instead');
         $index = 'itil_types';
      }
   ...
   public function offsetSet($index, $newval) {
      if ($index == 'ticket_types') {
         Toolbox::deprecated('See itil_types instead (well, in facts, do **not** override config!)');
         $index = 'itil_types';
      }
