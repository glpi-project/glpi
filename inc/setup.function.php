...
function showFormAddAuthMailServer($target) {
	...
	if (function_exists('imap_open')) {
		...
		echo "<table class='tab_cadre_fixe'>";
		echo "<tr><th colspan='2'>" . $LANG["login"][3] . "</th></tr>";
		echo "<tr class='tab_bg_2'><td align='center'>" . $LANG["common"][16] . "</td><td><input size='30' type=\"text\" name=\"name\" value=\"\" ></td></tr>";
		echo "<tr class='tab_bg_2'><td align='center'>" . $LANG["setup"][164] . "</td><td><input size='30' type=\"text\" name=\"imap_host\" value=\"\" ></td></tr>";
	...
	echo "<p class=\"submit\"><input type=\"submit\" name=\"add_mail\" class=\"submit\" value=\"" . $LANG["buttons"][2] . "\" ></p>";
	echo "</form>";
}

function showFormEditAuthMailServer($target) {
	...
	$ID = $_GET["ID"];
	$sql = "SELECT * from glpi_auth_mail WHERE ID=" . $ID;

	$result = $DB->query($sql);
	if ($DB->numrows($result) != 1)
		glpi_headers($target);
	else
		$mail_method = $DB->fetch_array($result);
	...
	if (function_exists('imap_open')) {
		...
		echo "<table class='tab_cadre_fixe'>";
		echo "<tr><th colspan='2'>" . $LANG["login"][3] . "</th></tr>";
		echo "<tr class='tab_bg_2'><td align='center'>" . $LANG["common"][16] . "</td><td><input size='30' type=\"text\" name=\"name\" value=\"" . $mail_method["name"] . "\" ></td></tr>";
		echo "<tr class='tab_bg_2'><td align='center'>" . $LANG["setup"][164] . "</td><td><input size='30' type=\"text\" name=\"imap_host\" value=\"" . $mail_method["imap_host"] . "\" ></td></tr>";

		showMailServerConfig($mail_method["imap_auth_server"]);
...
function showFormAddLdapServer($target) {
	...
	if (extension_loaded('ldap')) {
		...
		echo "<table class='tab_cadre_fixe'>";
		echo "<tr><th colspan='4'>" . $LANG["login"][2] . "</th></tr>";
		echo "<tr class='tab_bg_2'><td align='center'>" . $LANG["common"][16] . "</td><td><input type=\"text\" name=\"name\" value=\"\"></td>";
		...
		echo "<select name='ldap_search_for_groups'>\n";
		echo "<option value='0' selected>" . $LANG["setup"][256] . "</option>\n";
		echo "<option value='1'>" . $LANG["setup"][257] . "</option>\n";
		echo "<option value='2'>" . $LANG["setup"][258] . "</option>\n";
		echo "</select>\n";
		echo "</td>";
		echo "<td align='center'>" . $LANG["setup"][260] . "</td><td><input type=\"text\" name=\"ldap_field_group\" value=\"\" ></td></tr>";

		echo "<tr class='tab_bg_2'><td align='center'>" . $LANG["setup"][253] . "</td><td>";
		echo "<input type=\"text\" name=\"ldap_group_condition\" value=\"" . $CFG_GLPI["ldap_group_condition"] . "\" ></td>";
		echo "<td align='center'>" . $LANG["setup"][255] . "</td><td><input type=\"text\" name=\"ldap_field_group_member\" value=\"\" ></td></tr>";

		echo "<tr class='tab_bg_1'><td align='center' colspan='4'>" . $LANG["setup"][167] . "</td></tr>";

		echo "<tr class='tab_bg_2'><td align='center'>" . $LANG["common"][48] . "</td><td><input type=\"text\" name=\"ldap_field_realname\" value=\"\" ></td>";
		echo "<td align='center'>" . $LANG["common"][43] . "</td><td><input type=\"text\" name=\"ldap_field_firstname\" value=\"\" ></td></tr>";

		echo "<tr class='tab_bg_2'><td align='center'>" . $LANG["common"][15] . "</td><td><input type=\"text\" name=\"ldap_field_location\" value=\"\" ></td>";
		echo "<td align='center'>" . $LANG["setup"][14] . "</td><td><input type=\"text\" name=\"ldap_field_email\" value=\"\" ></td></tr>";

		echo "<tr class='tab_bg_2'><td align='center'>" . $LANG["financial"][29] . "</td><td><input type=\"text\" name=\"ldap_field_phone\" value=\"\" ></td>";
		echo "<td align='center'>" . $LANG["financial"][29] . " 2</td><td><input type=\"text\" name=\"ldap_field_phone2\" value=\"\" ></td></tr>";

		echo "<tr class='tab_bg_2'><td align='center'>" . $LANG["common"][42] . "</td><td><input type=\"text\" name=\"ldap_field_mobile\" value=\"\" ></td>";
		echo "<td align='center' colspan='2'>&nbsp;</td></tr>";
...
function showFormEditLdapServer($target) {
	...
	if (extension_loaded('ldap')) {
		...
		$ID = $_GET["ID"];
		$sql = "SELECT * from glpi_auth_ldap WHERE ID=" . $ID;

		$result = $DB->query($sql);
		if ($DB->numrows($result) != 1)
			glpi_headers($target);
		else
			$ldap_method = $DB->fetch_array($result);
		...
		echo "<tr class='tab_bg_2'><td align='center'>" . $LANG["common"][16] . "</td><td><input type=\"text\" name=\"name\" value=\"" . $ldap_method["name"] . "\"></td>";
		echo "<td align='center' colspan=2></tr>";

		echo "<tr class='tab_bg_2'><td align='center'>" . $LANG["common"][52] . "</td><td><input type=\"text\" name=\"ldap_host\" value=\"" . $ldap_method["ldap_host"] . "\"></td>";
		echo "<td align='center'>" . $LANG["setup"][172] . "</td><td><input type=\"text\" name=\"ldap_port\" value=\"" . $ldap_method["ldap_port"] . "\"></td></tr>";

		echo "<tr class='tab_bg_2'><td align='center'>" . $LANG["setup"][154] . "</td><td><input type=\"text\" name=\"ldap_basedn\" value=\"" . $ldap_method["ldap_basedn"] . "\" ></td>";
		echo "<td align='center'>" . $LANG["setup"][155] . "</td><td><input type=\"text\" name=\"ldap_rootdn\" value=\"" . $ldap_method["ldap_rootdn"] . "\" ></td></tr>";

		echo "<tr class='tab_bg_2'><td align='center'>" . $LANG["setup"][156] . "</td><td><input type=\"password\" name=\"ldap_pass\" value=\"" . $ldap_method["ldap_pass"] . "\" ></td>";
		echo "<td align='center'>" . $LANG["setup"][159] . "</td><td><input type=\"text\" name=\"ldap_condition\" value=\"" . $ldap_method["ldap_condition"] . "\" ></td></tr>";

		echo "<tr class='tab_bg_2'><td align='center'>" . $LANG["setup"][228] . "</td><td><input type=\"text\" name=\"ldap_login\" value=\"" . $ldap_method["ldap_login"] . "\" ></td>";
		echo "<td align='center'>" . $LANG["setup"][180] . "</td><td>";
		if (function_exists("ldap_start_tls")) {
			$ldap_use_tls = $ldap_method["ldap_use_tls"];
			echo "<select name='ldap_use_tls'>\n";
			echo "<option value='0' " . (!$ldap_use_tls ? " selected " : "") . ">" . $LANG["choice"][0] . "</option>\n";
			echo "<option value='1' " . ($ldap_use_tls ? " selected " : "") . ">" . $LANG["choice"][1] . "</option>\n";
			echo "</select>\n";
		...
		echo "<tr class='tab_bg_2'><td align='center'>" . $LANG["setup"][254] . "</td><td>";
		$ldap_search_for_groups = $ldap_method["ldap_search_for_groups"];
		...
		echo "</select>\n";
		echo "</td>";
		echo "<td align='center'>" . $LANG["setup"][260] . "</td><td><input type=\"text\" name=\"ldap_field_group\" value=\"" . $ldap_method["ldap_field_group"] . "\" ></td></tr>";

		echo "<tr class='tab_bg_2'><td align='center'>" . $LANG["setup"][253] . "</td><td>";
		echo "<input type=\"text\" name=\"ldap_group_condition\" value=\"" . $ldap_method["ldap_group_condition"] . "\" ></td>";
		echo "<td align='center'>" . $LANG["setup"][255] . "</td><td><input type=\"text\" name=\"ldap_field_group_member\" value=\"" . $ldap_method["ldap_field_group_member"] . "\" ></td></tr>";

		echo "<tr class='tab_bg_1'><td align='center' colspan='4'>" . $LANG["setup"][167] . "</td></tr>";

		echo "<tr class='tab_bg_2'><td align='center'>" . $LANG["common"][48] . "</td><td><input type=\"text\" name=\"ldap_field_realname\" value=\"" . $ldap_method["ldap_field_realname"] . "\" ></td>";
		echo "<td align='center'>" . $LANG["common"][43] . "</td><td><input type=\"text\" name=\"ldap_field_firstname\" value=\"" . $ldap_method["ldap_field_firstname"] . "\" ></td></tr>";

		echo "<tr class='tab_bg_2'><td align='center'>" . $LANG["common"][15] . "</td><td><input type=\"text\" name=\"ldap_field_location\" value=\"" . $ldap_method["ldap_field_location"] . "\" ></td>";
		echo "<td align='center'>" . $LANG["setup"][14] . "</td><td><input type=\"text\" name=\"ldap_field_email\" value=\"" . $ldap_method["ldap_field_email"] . "\" ></td></tr>";

		echo "<tr class='tab_bg_2'><td align='center'>" . $LANG["financial"][29] . "</td><td><input type=\"text\" name=\"ldap_field_phone\" value=\"" . $ldap_method["ldap_field_phone"] . "\" ></td>";
		echo "<td align='center'>" . $LANG["financial"][29] . " 2</td><td><input type=\"text\" name=\"ldap_field_phone2\" value=\"" . $ldap_method["ldap_field_phone2"] . "\" ></td></tr>";

		echo "<tr class='tab_bg_2'><td align='center'>" . $LANG["common"][42] . "</td><td><input type=\"text\" name=\"ldap_field_mobile\" value=\"" . $ldap_method["ldap_field_mobile"] . "\" ></td>";
		echo "<td align='center' colspan='2'>&nbsp;</td></tr>";
