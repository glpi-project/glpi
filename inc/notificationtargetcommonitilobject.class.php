   ...
   **/
   ...
   function getTags() {
      ...
      $tags = [$objettype.'.id'                    => __('ID'),
                    ...
                    'cost.name'                         => sprintf(__('%1$s: %2$s'), Cost::getTypeName(1),
                                                                   __('Name')),
                    'cost.comment'                      => sprintf(__('%1$s: %2$s'), Cost::getTypeName(1),
                                                                   __('Comments')),
                    'cost.datebegin'                    => sprintf(__('%1$s: %2$s'), Cost::getTypeName(1),
                                                                   __('Begin date')),
                    'cost.dateend'                      => sprintf(__('%1$s: %2$s'), Cost::getTypeName(1),
                                                                   __('End date')),
                    'cost.time'                         => sprintf(__('%1$s: %2$s'), Cost::getTypeName(1),
                                                                   __('Duration')),
                    'cost.costtime'                     => sprintf(__('%1$s: %2$s'), Cost::getTypeName(1),
                                                                   __('Time cost')),
                    'cost.costfixed'                    => sprintf(__('%1$s: %2$s'), Cost::getTypeName(1),
                                                                   __('Fixed cost')),
                    'cost.costmaterial'                 => sprintf(__('%1$s: %2$s'), Cost::getTypeName(1),
                                                                   __('Material cost')),
                    'cost.totalcost'                    => sprintf(__('%1$s: %2$s'), Cost::getTypeName(1),
                                                                   __('Total cost')),
                    'cost.budget'                       => sprintf(__('%1$s: %2$s'), Cost::getTypeName(1),
                                                                   __('Budget')),
