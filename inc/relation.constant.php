...
$RELATION = [
    ...
    'glpi_computers' => [
        ...
        'glpi_networkports'               => ['items_id', 'itemtype'],
        'glpi_networknames'               => ['items_id', 'itemtype'],
        'glpi_ipaddresses'                => ['mainitems_id', 'mainitemtype'],
        'glpi_items_operatingsystems'     => ['items_id', 'itemtype'],
        'glpi_items_disks'                => ['items_id', 'itemtype'],
        'glpi_items_devicecameras'        => ['items_id', 'itemtype'],
        'glpi_items_devicesimcards'       => ['items_id', 'itemtype'],
        'glpi_items_devicecases'          => ['items_id', 'itemtype'],
        'glpi_items_devicecontrols'       => ['items_id', 'itemtype'],
        'glpi_items_devicedrives'         => ['items_id', 'itemtype'],
        'glpi_items_devicegenerics'       => ['items_id', 'itemtype'],
        'glpi_items_devicegraphiccards'   => ['items_id', 'itemtype'],
        'glpi_items_deviceharddrives'     => ['items_id', 'itemtype'],
        'glpi_items_devicememories'       => ['items_id', 'itemtype'],
        'glpi_items_devicemotherboards'   => ['items_id', 'itemtype'],
        'glpi_items_devicenetworkcards'   => ['items_id', 'itemtype'],
        'glpi_items_devicepcis'           => ['items_id', 'itemtype'],
        'glpi_items_devicepowersupplies'  => ['items_id', 'itemtype'],
        'glpi_items_deviceprocessors'     => ['items_id', 'itemtype'],
        'glpi_items_devicesensors'        => ['items_id', 'itemtype'],
        'glpi_items_devicesoundcards'     => ['items_id', 'itemtype'],
        'glpi_items_devicebatteries'      => ['items_id', 'itemtype'],
        'glpi_items_devicefirmwares'      => ['items_id', 'itemtype'],
    ],
