...
class SessionExtension extends AbstractExtension implements GlobalsInterface {
   ...
   public function getFunctions(): array {
      return [
         ...
         new TwigFunction('getCurrentInterface', [Session::class, 'getCurrentInterface']),
         new TwigFunction('getLoginUserID', [Session::class, 'getLoginUserID']),
   ...
   public function getGlobals(): array {
      ...
      return [
         ...
         'is_demo_active'           => (bool) GLPI_DEMO_MODE,
