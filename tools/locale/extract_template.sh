...
xgettext `find ./ajax ./config ./front ./inc ./install ./src ./tests ./*.php -type f -name "*.php"` -o locales/glpi.pot -L PHP --add-comments=TRANS --from-code=UTF-8 --force-po --join-existing \
