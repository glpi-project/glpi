...
//	$FIRST["kbcategories"]=getMaxItem("glpi_knowbaseitemscategories")+1;
	...
	for ($i=0;$i<$MAX['user_type'];$i++){
		...
		$query="INSERT INTO glpi_userstypes VALUES (NULL,'$val','comment $val')";
		$DB->query($query) or die("PB REQUETE ".$query);
	}
...
function generate_entity($ID_entity){
	...
	for ($i=0;$i<$MAX['users_sadmin'];$i++){
		$query="INSERT INTO glpi_users (name, password_md5,email,phone,phone2,mobile,realname,firstname,comments,title,userstypes_id) VALUES ('sadmin$i-$ID_entity',MD5('sadmin$i'),'sadmin$i-$ID_entity@tutu.com','tel $i','tel2 $i','mobile $i','sadmin$i name','sadmin$i firstname','comments $i','".mt_rand(0,$MAX['user_title'])."','".mt_rand(0,$MAX['user_type'])."')";
		$DB->query($query) or die("PB REQUETE ".$query);
	...
	for ($i=0;$i<$MAX['users_admin'];$i++){
		$query="INSERT INTO glpi_users (name, password_md5,email,phone,phone2,mobile,realname,firstname,comments,title,userstypes_id) VALUES ('admin$i-$ID_entity',MD5('admin$i'),'admin$i-$ID_entity@tutu.com','tel $i','tel2 $i','mobile $i','admin$i name','admin$i firstname','comments $i','".mt_rand(0,$MAX['user_title'])."','".mt_rand(0,$MAX['user_type'])."')";
		$DB->query($query) or die("PB REQUETE ".$query);
		$user_id=$DB->insert_id();
	...
	for ($i=0;$i<$MAX['users_normal'];$i++){
		$query="INSERT INTO glpi_users (name, password_md5,email,phone,phone2,mobile,realname,firstname,comments,title,userstypes_id) VALUES ('normal$i-$ID_entity',MD5('normal$i'),'normal$i-$ID_entity@tutu.com','tel $i','tel2 $i','mobile $i','normal$i name','normal$i firstname','comments $i','".mt_rand(0,$MAX['user_title'])."','".mt_rand(0,$MAX['user_type'])."')";
		$DB->query($query) or die("PB REQUETE ".$query);
		$user_id=$DB->insert_id();
	...
	for ($i=0;$i<$MAX['users_postonly'];$i++){
		$query="INSERT INTO glpi_users (name, password_md5,email,phone,phone2,mobile,realname,firstname,comments,title,userstypes_id) VALUES ('postonly$i-$ID_entity',MD5('postonly$i'),'postonly$i-$ID_entity@tutu.com','tel $i','tel2 $i','mobile $i','postonly$i name','postonly$i firstname','comments $i','".mt_rand(0,$MAX['user_title'])."','".mt_rand(0,$MAX['user_type'])."')";
		$DB->query($query) or die("PB REQUETE ".$query);
		$user_id=$DB->insert_id();
