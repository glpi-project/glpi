...
function generate_entity($ID_entity){
	...
	for ($i=0;$i<$MAX['users_sadmin'];$i++){
		$query="INSERT INTO glpi_users VALUES (NULL,'sadmin$i-$ID_entity','',MD5('sadmin$i'),'sadmin$i-$ID_entity@tutu.com','tel $i','tel2 $i','mobile $i','sadmin$i name','sadmin$i firstname','0','0','fr_FR','0','20','1','comments $i','-1','-1',NOW(),NOW(),'0','0','0','".mt_rand(1,$MAX['user_title'])."','".mt_rand(1,$MAX['user_title'])."')";
		$DB->query($query) or die("PB REQUETE ".$query);
	...
	for ($i=0;$i<$MAX['users_admin'];$i++){
		$query="INSERT INTO glpi_users VALUES (NULL,'admin$i-$ID_entity','',MD5('admin$i'),'admin$i-$ID_entity@tutu.com','tel $i','tel2 $i','mobile $i','admin$i name','admin$i firstname','0','0','fr_FR','0','20','1','comments $i','-1','-1',NOW(),NOW(),'0','0','0','".mt_rand(1,$MAX['user_title'])."','".mt_rand(1,$MAX['user_title'])."')";
		$DB->query($query) or die("PB REQUETE ".$query);
		$user_id=$DB->insert_id();
	...
	for ($i=0;$i<$MAX['users_normal'];$i++){
		$query="INSERT INTO glpi_users VALUES (NULL,'normal$i-$ID_entity','',MD5('normal$i'),'normal$i-$ID_entity@tutu.com','tel $i','tel2 $i','mobile $i','normal$i name','normal$i firstname','0','0','fr_FR','0','20','1','comments $i','-1','-1',NOW(),NOW(),'0','0','0','".mt_rand(1,$MAX['user_title'])."','".mt_rand(1,$MAX['user_title'])."')";
		$DB->query($query) or die("PB REQUETE ".$query);
		$user_id=$DB->insert_id();
	...
	for ($i=0;$i<$MAX['users_postonly'];$i++){
		$query="INSERT INTO glpi_users VALUES (NULL,'postonly$i-$ID_entity','',MD5('postonly$i'),'postonly$i-$ID_entity@tutu.com','tel $i','tel2 $i','mobile $i','postonly$i name','postonly$i firstname','0','0','fr_FR','0','20','1','comments $i','-1','-1',NOW(),NOW(),'0','0','0','".mt_rand(1,$MAX['user_title'])."','".mt_rand(1,$MAX['user_title'])."')";
		$DB->query($query) or die("PB REQUETE ".$query);
		$user_id=$DB->insert_id();
	...
	while ($data=$DB->fetch_array($result)){
		...
		$query="INSERT INTO glpi_printers VALUES (NULL,'$ID_entity','printer of loc ".$data['ID']."',NOW(),'contact ".$data['ID']."','num ".$data['ID']."','$techID','".getRandomString(10)."','".getRandomString(10)."','0','0','1','comments $i','".mt_rand(0,64)."','".$data['ID']."','$domainID','$networkID','$modelID','$typeID','".mt_rand(1,$MAX['manufacturer'])."','1','0','0','','0','notes printers ".$data['ID']."','".mt_rand($FIRST['users_sadmin'],$LAST['users_admin'])."','".mt_rand($FIRST["groups"],$LAST["groups"])."','".(mt_rand(0,100)<$percent['state']?mt_rand(1,$MAX['state']):0)."','0')";
		$DB->query($query) or die("PB REQUETE ".$query);
