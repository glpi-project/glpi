	...
	function haveRight ($type){
		...
		switch ($this->device_type){
			case GENERAL_TYPE :
				...
				break;
			case COMPUTER_TYPE :
				return haveRight("computer",$type);
				break;
			case NETWORKING_TYPE :
				return haveRight("networking",$type);
				break;
			case PRINTER_TYPE :
				return haveRight("printer",$type);
				break;
			case MONITOR_TYPE : 
				return haveRight("monitor",$type);
				break;
			case PERIPHERAL_TYPE : 
				return haveRight("peripheral",$type);
				break;				
			case PHONE_TYPE : 
				return haveRight("phone",$type);
				break;				
			case SOFTWARE_TYPE : 
				return haveRight("software",$type);
				break;				
			case CONTRACT_TYPE : 
				return haveRight("contract_infocom",$type);
				break;				
			case ENTERPRISE_TYPE : 
				return haveRight("contact_enterprise",$type);
				break;
			case CONTACT_TYPE : 
				return haveRight("contact_enterprise",$type);
				break;
			case KNOWBASE_TYPE : 
				return haveRight("knowbase",$type);
				break;	
			case USER_TYPE : 
				return haveRight("user",$type);
				break;	
			case TRACKING_TYPE : 
				return haveRight("show_ticket",$type);
				break;	
			case CARTRIDGE_TYPE : 
				return haveRight("cartridge",$type);
				break;
			case CONSUMABLE_TYPE : 
				return haveRight("consumable",$type);
				break;					
			case LICENSE_TYPE : 
				return haveRight("software",$type);
				break;					
			...
			case CONSUMABLE_ITEM_TYPE : 
				...
				break;					
			case DOCUMENT_TYPE : 
				return haveRight("document",$type);
				break;					
			}
