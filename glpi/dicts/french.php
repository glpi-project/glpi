...
$lang["update"][98]	= "Vous devez en creer un absolument afin de pouvoir re-configurer l'application (notamment les accès aux sources de données externes)";
...
$lang["update"][107]	= "Voulez devez maintenant procèder à la mise a jour de l'ancien contenu de votre base de données";
