...
$lang["install"][18]="Vérifiez que PHP a un droit d'écriture pour le répertoire : 'backups/dump/'. Si vous êtes sous un environnement de Microsoft Windows, contrôlez si celui-ci est en lecture seule.";
...
$lang["install"][22]="Vérifiez que PHP a un droit d'écriture pour le répertoire : '/docs'. Si vous êtes sous un environnement de Microsoft Windows, contrôlez si celui-ci est en lecture seule.";
$lang["install"][23]="Test d'écriture du fichier de configuration";
$lang["install"][24]="Vérifiez que PHP a un droit d'écriture pour le répertoire : 'glpi/config/'. Si vous êtes sous un environnement de Microsoft Windows, contrôlez si celui-ci est en lecture seule.";
