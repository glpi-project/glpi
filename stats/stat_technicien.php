...
echo $lang["search"][8].":</td><td> <input type=\"texte\" readonly name=\"date1\"  size ='10' value=\"". $_POST["date1"] ."\" /></td>";
...
echo "<tr class='tab_bg_2'><td align='right'>".$lang["search"][9]."</td><td><input type=\"texte\" readonly name=\"date2\"  size ='10' value=\"". $_POST["date2"] ."\" /></td>";
