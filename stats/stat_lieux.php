...
echo "<option value=\"glpi_type_computers\" ".($dropdown=="glpi_type_computers"?"selected":"").">".$lang["computers"][8]."</option>";
echo "<option value=\"glpi_dropdown_os\" ".($dropdown=="glpi_dropdown_os"?"selected":"").">".$lang["computers"][9]."</option>";
echo "<option value=\"glpi_dropdown_moboard\" ".($dropdown=="glpi_dropdown_moboard"?"selected":"").">".$lang["computers"][35]."</option>";
echo "<option value=\"glpi_dropdown_processor\" ".($dropdown=="glpi_dropdown_processor"?"selected":"").">".$lang["setup"][7]."</option>";
echo "<option value=\"glpi_dropdown_locations\" ".($dropdown=="glpi_dropdown_locations"?"selected":"").">".$lang["stats"][21]."</option>";
echo "<option value=\"glpi_dropdown_gfxcard\" ".($dropdown=="glpi_dropdown_gfxcard"?"selected":"").">".$lang["computers"][34]."</option>";
echo "<option value=\"glpi_dropdown_hdtype\" ".($dropdown=="glpi_dropdown_hdtype"?"selected":"").">".$lang["computers"][36]."</option>";
echo "</select>";
