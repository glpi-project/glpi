...
echo "<div align ='center'><p><b>".$lang["stats"][37]."</b></p></div>";
...
//foreach these authors display
   foreach($nomUsr as $key)
   {
	...
	echo "<td>".$key["category"]."</td>";
		...
		echo "<td>".getNbinter(4,'glpi_tracking.category',$key["ID"], $_POST["date1"], $_POST["date2"])."</td>";
		echo "<td>".getNbresol(4,'glpi_tracking.category',$key["ID"], $_POST["date1"], $_POST["date2"])."</td>";
		echo "<td>".getResolAvg(4, 'glpi_tracking.category',$key["ID"], $_POST["date1"], $_POST["date2"])."</td>";
		echo "<td>".getRealAvg(4, 'glpi_tracking.category',$key["ID"], $_POST["date1"], $_POST["date2"])."</td>";
		echo "<td>".getRealTotal(4, 'glpi_tracking.category',$key["ID"], $_POST["date1"], $_POST["date2"])."</td>";
		echo "<td>".getFirstActionAvg(4, 'glpi_tracking.category',$key["ID"], $_POST["date1"], $_POST["date2"])."</td>";
